...
namespace LaraPress\Filesystem;

use Closure;
use LaraPress\Contracts\Filesystem\Cloud as CloudFilesystemContract;
use LaraPress\Contracts\Filesystem\FileExistsException as ContractFileExistsException;
use LaraPress\Contracts\Filesystem\FileNotFoundException as ContractFileNotFoundException;
use LaraPress\Contracts\Filesystem\Filesystem as FilesystemContract;
use LaraPress\Http\File;
use LaraPress\Http\UploadedFile;
...
class FilesystemAdapter implements CloudFilesystemContract
{
     ...
     * @return string
     *
     * @throws \LaraPress\Contracts\Filesystem\FileNotFoundException
     */
     ...
     *
     * @param string $path
     * @param \Psr\Http\Message\StreamInterface|\LaraPress\Http\File|\LaraPress\Http\UploadedFile|string|resource $contents
     * @param mixed $options
     * @return bool
     */
     ...
     *
     * @param string $path
     * @param \LaraPress\Http\File|\LaraPress\Http\UploadedFile|string $file
     * @param mixed $options
     * @return string|false
     */
