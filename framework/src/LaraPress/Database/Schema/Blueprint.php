...
use LaraPress\Database\Schema\Grammars\Grammar;
use LaraPress\Database\SQLiteConnection;
...
class Blueprint
{
     ...
     *
     * @var \LaraPress\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @return \LaraPress\Support\Fluent
     */
     ...
     *
     * @param string $column
     * @return \LaraPress\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param string $column
     * @return \LaraPress\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param \LaraPress\Database\Schema\ColumnDefinition $definition
     * @return \LaraPress\Database\Schema\ColumnDefinition
     */
