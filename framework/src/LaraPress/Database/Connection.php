...
use LaraPress\Database\Events\QueryExecuted;
use LaraPress\Database\Events\StatementPrepared;
use LaraPress\Database\Events\TransactionBeginning;
use LaraPress\Database\Events\TransactionCommitted;
use LaraPress\Database\Events\TransactionRolledBack;
use LaraPress\Database\Query\Builder as QueryBuilder;
use LaraPress\Database\Query\Expression;
use LaraPress\Database\Query\Grammars\Grammar as QueryGrammar;
use LaraPress\Database\Query\Processors\Processor;
use LaraPress\Database\Schema\Builder as SchemaBuilder;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var \LaraPress\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @var \LaraPress\Database\DatabaseTransactionsManager
     */
     ...
     *
     * @return \LaraPress\Database\Schema\Grammars\Grammar
     */
     ...
     * @return mixed
     *
     * @throws \LaraPress\Database\QueryException
     */
     ...
     *
     * @param \LaraPress\Database\QueryException $e
     * @param string $query
     * @param array $bindings
     * @param \Closure $callback
     * @return mixed
     ...
     *
     * @param \LaraPress\Database\Query\Grammars\Grammar $grammar
     * @return $this
     */
     ...
     *
     * @param \LaraPress\Database\Query\Processors\Processor $processor
     * @return $this
     */
     ...
     *
     * @param \LaraPress\Database\DatabaseTransactionsManager $manager
     * @return $this
     */
     ...
     *
     * @param \LaraPress\Database\Grammar $grammar
     * @return \LaraPress\Database\Grammar
     */
