...
namespace LaraPress\Database\Migrations;

use Doctrine\DBAL\Schema\SchemaException;
use LaraPress\Contracts\Events\Dispatcher;
use LaraPress\Database\ConnectionResolverInterface as Resolver;
use LaraPress\Database\Events\MigrationEnded;
use LaraPress\Database\Events\MigrationsEnded;
use LaraPress\Database\Events\MigrationsStarted;
use LaraPress\Database\Events\MigrationStarted;
use LaraPress\Database\Events\NoPendingMigrations;
...
class Migrator
{
     ...
     *
     * @var \LaraPress\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @param \LaraPress\Database\Migrations\MigrationRepositoryInterface $repository
    ...
    protected function resetMigrations(array $migrations, array $paths, $pretend = false)
    {
        ...
        $migrations = lp_collect($migrations)->map(function ($m) {
    ...
    public function usingConnection($name, callable $callback)
    {
        ...
        return lp_tap($callback(), function () use ($previousConnection) {
     ...
     *
     * @return \LaraPress\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @return \LaraPress\Filesystem\Filesystem
     */
     ...
     *
     * @param \LaraPress\Contracts\Database\Events\MigrationEvent $event
     * @return void
     */
