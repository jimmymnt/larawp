...
namespace LaraPress\Database\Eloquent\Relations;

use Closure;
use LaraPress\Contracts\Support\Arrayable;
use LaraPress\Database\Eloquent\Builder;
use LaraPress\Database\Eloquent\Collection;
...
use LaraPress\Database\Eloquent\Relations\Concerns\InteractsWithDictionary;
use LaraPress\Database\Eloquent\Relations\Concerns\InteractsWithPivotTable;
...
class BelongsToMany extends Relation
{
    ...
    protected function resolveTableName($table)
    {
        ...
        if (in_array(AsPivot::class, lp_class_uses_recursive($model))) {
            $this->using($table);
        }
     ...
     *
     * @param \LaraPress\Database\Eloquent\Builder|null $query
     * @return $this
     */
     ...
     *
     * @param array $models
     * @param \LaraPress\Database\Eloquent\Collection $results
     * @param string $relation
     * @return array
     */
     ...
     * @param mixed $id
     * @param array $columns
     * @return \LaraPress\Support\Collection|\LaraPress\Database\Eloquent\Model
     */
     ...
     * @param mixed $id
     * @param array $columns
     * @return \LaraPress\Database\Eloquent\Model|\LaraPress\Database\Eloquent\Collection|null
     */
     ...
     * @param mixed $id
     * @param array $columns
     * @return \LaraPress\Database\Eloquent\Model|\LaraPress\Database\Eloquent\Collection
     *
    ...
    protected function aliasedPivotColumns()
    {
        ...
        return lp_collect(array_merge($defaults, $this->pivotColumns))->map(function ($column) {
    ...
    public function paginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        return lp_tap($this->query->paginate($perPage, $columns, $pageName, $page), function ($paginator) {
    ...
    public function simplePaginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        return lp_tap($this->query->simplePaginate($perPage, $columns, $pageName, $page), function ($paginator) {
            $this->hydratePivotRelation($paginator->items());
        });
    }
    ...
    public function cursorPaginate($perPage = null, $columns = ['*'], $cursorName = 'cursor', $cursor = null)
    {
        ...
        return lp_tap($this->query->cursorPaginate($perPage, $columns, $cursorName, $cursor), function ($paginator) {
            $this->hydratePivotRelation($paginator->items());
        });
    }
    ...
    {
        return Str::camel(Str::pluralStudly(lp_class_basename($this->getParent())));
    }
     ...
     *
     * @param \LaraPress\Support\Collection|array $models
     * @param array $pivotAttributes
     * @return array
     */
     ...
     *
     * @param \LaraPress\Database\Eloquent\Builder $query
     * @param \LaraPress\Database\Eloquent\Builder $parentQuery
