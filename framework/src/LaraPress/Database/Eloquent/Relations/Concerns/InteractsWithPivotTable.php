...
trait InteractsWithPivotTable
{
     ...
     *
     * @param \LaraPress\Support\Collection|\LaraPress\Database\Eloquent\Model|array $ids
     * @return array
     */
    ...
    {
        return $this->sync(lp_collect($this->parseIds($ids))->mapWithKeys(function ($id) use ($values) {
            return [$id => $values];
        }), $detaching);
    }
    ...
    {
        return lp_collect($records)->mapWithKeys(function ($attributes, $id) {
