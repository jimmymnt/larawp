...
use LaraPress\Contracts\Queue\QueueableCollection;
use LaraPress\Contracts\Queue\QueueableEntity;
use LaraPress\Contracts\Routing\UrlRoutable;
use LaraPress\Contracts\Support\Arrayable;
use LaraPress\Contracts\Support\CanBeEscapedWhenCastToString;
use LaraPress\Contracts\Support\Jsonable;
use LaraPress\Database\ConnectionResolverInterface as Resolver;
use LaraPress\Database\Eloquent\Collection as EloquentCollection;
use LaraPress\Database\Eloquent\Relations\BelongsToMany;
use LaraPress\Database\Eloquent\Relations\Concerns\AsPivot;
use LaraPress\Database\Eloquent\Relations\HasManyThrough;
use LaraPress\Database\Eloquent\Relations\Pivot;
use LaraPress\Support\Arr;
use LaraPress\Support\Collection as BaseCollection;
use LaraPress\Support\Str;
use LaraPress\Support\Traits\ForwardsCalls;
use JsonSerializable;
use LogicException;
use LaraPress\Database\Eloquent\Contracts\Model as ModelContract;
...
abstract class Model implements ModelContract, Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
     ...
     * @return $this
     *
     * @throws \LaraPress\Database\Eloquent\MassAssignmentException
     */
    ...
    {
        return lp_collect($columns)->map(function ($column) {
    ...
    protected function incrementOrDecrement($column, $amount, $extra, $method)
    {
        ...
        return lp_tap($this->setKeysForSaveQuery($query)->{$method}($column, $amount, $extra), function () use ($column) {
            $this->syncChanges();
     ...
     *
     * @param \LaraPress\Database\Eloquent\Builder $query
     * @return bool
     */
     ...
     *
     * @param \LaraPress\Support\Collection|array|int|string $ids
     * @return int
     */
     ...
     *
     * @return \LaraPress\Database\Eloquent\Builder|static
     */
     ...
     *
     * @param \LaraPress\Database\Eloquent\Model $parent
     * @param array $attributes
     * @param string $table
     * @param bool $exists
     * @param string|null $using
     * @return \LaraPress\Database\Eloquent\Relations\Pivot
     */
    ...
    public function refresh()
    {
        ...
        $this->load(lp_collect($this->relations)->reject(function ($relation) {
            return $relation instanceof Pivot
                || (is_object($relation) && in_array(AsPivot::class, lp_class_uses_recursive($relation), true));
        })->keys()->all());
    ...
    public function replicate(array $except = null)
    {
        ...
        return lp_tap(new static, function ($instance) use ($attributes) {
     ...
     *
     * @param \LaraPress\Database\Eloquent\Model|null $model
     * @return bool
     */
     ...
     *
     * @return \LaraPress\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param \LaraPress\Database\ConnectionResolverInterface $resolver
     * @return void
     */
    ...
    {
        return $this->table ?? Str::snake(Str::pluralStudly(lp_class_basename($this)));
    }
     ...
     * @return \LaraPress\Database\Eloquent\Model|null
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param \LaraPress\Database\Eloquent\Model|LaraPress\Database\Eloquent\Relations\Relation $query
     * @param mixed $value
     * @param string|null $field
     * @return \LaraPress\Database\Eloquent\Relations\Relation
     */
    ...
    {
        return str_replace('\\', '.', get_class($this)) . '.{' . Str::camel(lp_class_basename($this)) . '}';
    }
