...
use LaraPress\Database\MultipleRecordsFoundException;
use LaraPress\Database\RecordsNotFoundException;
use LaraPress\Pagination\Cursor;
use LaraPress\Pagination\CursorPaginator;
use LaraPress\Pagination\LengthAwarePaginator;
...
trait BuildsQueries
{
     ...
     * @return \LaraPress\Database\Eloquent\Model|object|static|null
     */
     ...
     * @return \LaraPress\Database\Eloquent\Model|object|static|null
     *
     * @throws \LaraPress\Database\RecordsNotFoundException
     ...
     *
     * @param \LaraPress\Database\Query\Builder|\LaraPress\Database\Eloquent\Builder $builder
     ...
     *
     * @param \LaraPress\Support\Collection $items
     * @param int $total
     * @param int $perPage
     * @param int $currentPage
     * @param array $options
     * @return \LaraPress\Pagination\LengthAwarePaginator
     */
     ...
     * @param int $currentPage
     * @param array $options
     * @return \LaraPress\Pagination\Paginator
     */
     ...
     * @param \LaraPress\Support\Collection $items
     * @param int $perPage
     * @param \LaraPress\Pagination\Cursor $cursor
     * @param array $options
     * @return \LaraPress\Pagination\CursorPaginator
     */
