...
namespace LaraPress\Validation\Rules;

use LaraPress\Container\Container;
use LaraPress\Contracts\Validation\DataAwareRule;
use LaraPress\Contracts\Validation\Rule;
use LaraPress\Contracts\Validation\UncompromisedVerifier;
use LaraPress\Contracts\Validation\ValidatorAwareRule;
use LaraPress\Support\Arr;
use LaraPress\Support\Facades\Validator;
...
class Password implements Rule, DataAwareRule, ValidatorAwareRule
{
    ...
    {
        $messages = lp_collect(Arr::wrap($messages))->map(function ($message) {
