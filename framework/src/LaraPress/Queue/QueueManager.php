...
use Closure;
use LaraPress\Contracts\Queue\Factory as FactoryContract;
use LaraPress\Contracts\Queue\Monitor as MonitorContract;
...
class QueueManager implements FactoryContract, MonitorContract
{
     ...
     *
     * @param string $driver
     * @return \LaraPress\Queue\Connectors\ConnectorInterface
     *
     * @throws \InvalidArgumentException
     */
