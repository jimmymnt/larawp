...
namespace LaraPress\Queue;

use Aws\DynamoDb\DynamoDbClient;
use LaraPress\Contracts\Debug\ExceptionHandler;
use LaraPress\Contracts\Support\DeferrableProvider;
use LaraPress\Queue\Connectors\BeanstalkdConnector;
use LaraPress\Queue\Connectors\DatabaseConnector;
use LaraPress\Queue\Connectors\NullConnector;
use LaraPress\Queue\Connectors\RedisConnector;
use LaraPress\Queue\Connectors\SqsConnector;
use LaraPress\Queue\Connectors\SyncConnector;
use LaraPress\Queue\Failed\DatabaseFailedJobProvider;
use LaraPress\Queue\Failed\DatabaseUuidFailedJobProvider;
use LaraPress\Queue\Failed\DynamoDbFailedJobProvider;
use LaraPress\Queue\Failed\NullFailedJobProvider;
...
class QueueServiceProvider extends ServiceProvider implements DeferrableProvider
{
    ...
    protected function registerManager()
    {
        $this->app->singleton('queue', function ($app) {
            ...
            return lp_tap(new QueueManager($app), function ($manager) {
     ...
     *
     * @param \LaraPress\Queue\QueueManager $manager
     * @return void
     */
     ...
     *
     * @param array $config
     * @return \LaraPress\Queue\Failed\DatabaseFailedJobProvider
     */
     ...
     *
     * @param array $config
     * @return \LaraPress\Queue\Failed\DatabaseUuidFailedJobProvider
     */
     ...
     *
     * @param array $config
     * @return \LaraPress\Queue\Failed\DynamoDbFailedJobProvider
     */
