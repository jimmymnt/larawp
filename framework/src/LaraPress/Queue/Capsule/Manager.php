...
namespace LaraPress\Queue\Capsule;

use LaraPress\Container\Container;
use LaraPress\Queue\QueueManager;
use LaraPress\Queue\QueueServiceProvider;
use LaraPress\Support\Traits\CapsuleManagerTrait;

/**
 * @mixin \LaraPress\Queue\QueueManager
 * @mixin \LaraPress\Contracts\Queue\Queue
 */
class Manager
{
     ...
     *
     * @var \LaraPress\Queue\QueueManager
     */
    protected $manager;
