...
use LaraPress\Contracts\Cache\Repository as CacheContract;
use LaraPress\Contracts\Debug\ExceptionHandler;
use LaraPress\Contracts\Events\Dispatcher;
use LaraPress\Contracts\Queue\Factory as QueueManager;
use LaraPress\Database\DetectsLostConnections;
use LaraPress\Queue\Events\JobExceptionOccurred;
use LaraPress\Queue\Events\JobProcessed;
use LaraPress\Queue\Events\JobProcessing;
use LaraPress\Queue\Events\Looping;
use LaraPress\Queue\Events\WorkerStopping;
...
class Worker
{
     ...
     * @param \LaraPress\Contracts\Debug\ExceptionHandler $exceptions
     ...
     * @param string $queue
     * @param \LaraPress\Queue\WorkerOptions $options
     * @return int
     */
     ...
     *
     * @param \LaraPress\Contracts\Queue\Job|null $job
     * @param \LaraPress\Queue\WorkerOptions $options
     * @return void
     */
     ...
     *
     * @param \LaraPress\Contracts\Queue\Queue $connection
     * @param string $queue
     * @return \LaraPress\Contracts\Queue\Job|null
     */
    ...
    protected function calculateBackoff($job, WorkerOptions $options)
    {
        ...
        return (int)($backoff[$job->attempts() - 1] ?? lp_last($backoff));
    }
     ...
     *
     * @param \LaraPress\Contracts\Queue\Job $job
     * @return \LaraPress\Queue\MaxAttemptsExceededException
     */
     ...
     *
     * @return \LaraPress\Queue\QueueManager
     */
