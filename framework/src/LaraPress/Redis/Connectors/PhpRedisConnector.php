...
use LaraPress\Redis\Connections\PhpRedisClusterConnection;
use LaraPress\Redis\Connections\PhpRedisConnection;
use LaraPress\Support\Arr;
use LaraPress\Support\Facades\Redis as RedisFacade;
...
class PhpRedisConnector implements Connector
{
     ...
     * @param array $config
     * @param array $options
     * @return \LaraPress\Redis\Connections\PhpRedisConnection
     */
     ...
     * @param array $options
     * @return \LaraPress\Redis\Connections\PhpRedisClusterConnection
     */
    ...
    {
        return lp_tap(new Redis, function ($client) use ($config) {
    ...
    protected function createRedisClusterInstance(array $servers, array $options)
    {
        ...
        return lp_tap(new RedisCluster(...$parameters), function ($client) use ($options) {
