...
namespace LaraPress\Redis\Connections;

use Closure;
use LaraPress\Contracts\Events\Dispatcher;
use LaraPress\Redis\Events\CommandExecuted;
use LaraPress\Redis\Limiters\ConcurrencyLimiterBuilder;
use LaraPress\Redis\Limiters\DurationLimiterBuilder;
...
abstract class Connection
{
     ...
     *
     * @param string $name
     * @return \LaraPress\Redis\Limiters\ConcurrencyLimiterBuilder
     */
     ...
     *
     * @param string $name
     * @return \LaraPress\Redis\Limiters\DurationLimiterBuilder
     */
