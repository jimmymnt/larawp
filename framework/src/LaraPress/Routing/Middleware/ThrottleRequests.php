...
use Closure;
use LaraPress\Cache\RateLimiter;
use LaraPress\Cache\RateLimiting\Unlimited;
use LaraPress\Http\Exceptions\HttpResponseException;
use LaraPress\Http\Exceptions\ThrottleRequestsException;
...
class ThrottleRequests
{
     ...
     *
     * @var \LaraPress\Cache\RateLimiter
     */
    protected $limiter;
     ...
     *
     * @param \LaraPress\Cache\RateLimiter $limiter
     * @return void
     */
     ...
     *
     * @throws \LaraPress\Http\Exceptions\ThrottleRequestsException
     */
    ...
    protected function handleRequestUsingNamedLimiter($request, Closure $next, $limiterName, Closure $limiter)
    {
        ...
        return $this->handleRequest(
            $request,
            $next,
            lp_collect(Arr::wrap($limiterResponse))->map(function ($limit) use ($limiterName) {
                return (object)[
     ...
     * @return \LaraPress\Http\Exceptions\ThrottleRequestsException
     */
