...
use LaraPress\Contracts\Routing\BindingRegistrar;
use LaraPress\Contracts\Routing\Registrar as RegistrarContract;
...
use LaraPress\Http\JsonResponse;
use LaraPress\Http\Request;
use LaraPress\Http\Response;
use LaraPress\Routing\Events\RouteMatched;
use LaraPress\Support\Collection;
use LaraPress\Support\Str;
use LaraPress\Support\Stringable;
...
/**
 * @mixin \LaraPress\Routing\RouteRegistrar
 */
class Router implements BindingRegistrar, RegistrarContract
{
     ...
     *
     * @var \LaraPress\Routing\RouteCollectionInterface
     */
    protected $routes;
     ...
     *
     * @var \LaraPress\Routing\Route|null
     */
    protected $current;
     ...
     * @param \LaraPress\Container\Container|null $container
     * @return void
     */
    ...
    {
        return $this->any($uri, '\LaraPress\Routing\RedirectController')
    ...
    {
        return $this->match(['GET', 'HEAD'], $uri, '\LaraPress\Routing\ViewController')
            ->setDefaults([
                'view' => $view,
                'data' => $data,
    ...
    {
        $route = lp_tap($this->routes->getByName($name))->bind($this->currentRequest);
    ...
    public function gatherRouteMiddleware(Route $route)
    {
        ...
        $excluded = lp_collect($route->excludedMiddleware())->map(function ($name) {
            return (array)MiddlewareNameResolver::resolve($name, $this->middleware, $this->middlewareGroups);
        })->flatten()->values()->all();

        $middleware = lp_collect($computedMiddleware)->map(function ($name) {
            return (array)MiddlewareNameResolver::resolve($name, $this->middleware, $this->middlewareGroups);
            ...
            return lp_collect($excluded)->contains(function ($exclude) use ($reflection) {
     ...
     *
     * @param \LaraPress\Support\Collection $middlewares
     * @return array
     */
     ...
     *
     * @return \LaraPress\Routing\RouteCollectionInterface
     */
