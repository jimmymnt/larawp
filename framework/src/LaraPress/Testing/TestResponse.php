...
use LaraPress\Cookie\CookieValuePrefix;
...
use LaraPress\Support\Traits\Tappable;
use LaraPress\Testing\Assert as PHPUnit;
use LaraPress\Testing\Constraints\SeeInOrder;
use LaraPress\Testing\Fluent\AssertableJson;
use LogicException;
use Symfony\Component\HttpFoundation\StreamedResponse;

/**
 * @mixin \LaraPress\Http\Response
 */
...
EOF;
    ...
    {
        PHPUnit::assertEquals(
            lp_app('url')->to($uri), lp_app('url')->to($this->headers->get('Location'))
        );
    ...
    public function assertCookie($cookieName, $value = null, $encrypted = true, $unserialize = false)
    {
        ...
        $actual = $encrypted
            ? CookieValuePrefix::remove(lp_app('encrypter')->decrypt($cookieValue, $unserialize))
            : $cookieValue;
    ...
    public function assertSee($value, $escape = true)
    {
        ...
        $values = $escape ? array_map('lp_e', ($value)) : $value;
    ...
    public function assertSeeText($value, $escape = true)
    {
        ...
        lp_tap(strip_tags($this->getContent()), function ($content) use ($values) {
            foreach ($values as $value) {
     ...
     *
     * @return \LaraPress\Testing\AssertableJsonString
     *
     * @throws \Throwable
     */
     ...
     *
     * @return \LaraPress\Session\Store
     */
    protected function session()
    {
        return lp_app('session.store');
    }
     ...
     *
     * @param \LaraPress\Support\Collection $exceptions
     * @return $this
     */
