...
use LaraPress\Contracts\Mail\Factory as FactoryContract;
use LaraPress\Log\LogManager;
use LaraPress\Mail\Transport\ArrayTransport;
use LaraPress\Mail\Transport\LogTransport;
use LaraPress\Mail\Transport\MailgunTransport;
use LaraPress\Mail\Transport\SesTransport;
...
class MailManager implements FactoryContract
{
     ...
     *
     * @param array $config
     * @return \LaraPress\Mail\Transport\SesTransport
     */
     ...
     *
     * @param array $config
     * @return \LaraPress\Mail\Transport\MailgunTransport
     */
    ...
    protected function createPostmarkTransport(array $config)
    {
        ...
        return lp_tap(new PostmarkTransport(
     ...
     *
     * @param array $config
     * @return \LaraPress\Mail\Transport\LogTransport
     */
     ...
     *
     * @return \LaraPress\Mail\Transport\ArrayTransport
     */
     ...
     *
     * @param \LaraPress\Mail\Mailer $mailer
     * @param array $config
     * @param string $type
     * @return void
     */
