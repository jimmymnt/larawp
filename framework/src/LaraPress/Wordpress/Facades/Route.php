 ...
 * @method static \LaraPress\Wordpress\Routing\Route any(string $uri, array|string|callable|null $action = null)
 * @method static \LaraPress\Wordpress\Routing\Route|null current()
 * @method static \LaraPress\Wordpress\Routing\Route delete(string $uri, array|string|callable|null $action = null)
 * @method static \LaraPress\Wordpress\Routing\Route fallback(array|string|callable|null $action = null)
 * @method static \LaraPress\Wordpress\Routing\Route get(string $uri, array|string|callable|null $action = null)
 * @method static \LaraPress\Wordpress\Routing\Route|null getCurrentRoute()
 * @method static \LaraPress\Routing\RouteCollectionInterface getRoutes()
 * @method static \LaraPress\Wordpress\Routing\Route match(array|string $methods, string $uri, array|string|callable|null $action = null)
 * @method static \LaraPress\Wordpress\Routing\Route options(string $uri, array|string|callable|null $action = null)
 * @method static \LaraPress\Wordpress\Routing\Route patch(string $uri, array|string|callable|null $action = null)
 * @method static \LaraPress\Wordpress\Routing\Route permanentRedirect(string $uri, string $destination)
 * @method static \LaraPress\Wordpress\Routing\Route post(string $uri, array|string|callable|null $action = null)
 * @method static \LaraPress\Wordpress\Routing\Route put(string $uri, array|string|callable|null $action = null)
 * @method static \LaraPress\Wordpress\Routing\Route redirect(string $uri, string $destination, int $status = 302)
 * @method static \LaraPress\Wordpress\Routing\Route substituteBindings(\LaraPress\Support\Facades\Route $route)
 * @method static \LaraPress\Wordpress\Routing\Route view(string $uri, string $view, array $data = [], int|array $status = 200, array $headers = [])
 ...
 *
 * @see \LaraPress\Wordpress\Routing\Router
 */
