...
class Router
{
     ...
     *
     * @var \LaraPress\Wordpress\Admin\Routing\Menu|null
     */
    protected $current;
     ...
     *
     * @param \LaraPress\Http\Request $request
     * @param \LaraPress\Wordpress\Admin\Routing\Menu $menu
     * @return \Symfony\Component\HttpFoundation\Response
     */
    ...
    public function gatherMenuMiddleware(Menu $menu)
    {
        ...
        $excluded = lp_collect($menu->excludedMiddleware())->map(function ($name) {
