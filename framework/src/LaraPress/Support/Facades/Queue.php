...
use LaraPress\Support\Testing\Fakes\QueueFake;

/**
 * @method static \LaraPress\Contracts\Queue\Job|null pop(string $queue = null)
 * @method static \LaraPress\Contracts\Queue\Queue setConnectionName(string $name)
 ...
 *
 * @see \LaraPress\Queue\QueueManager
 * @see \LaraPress\Queue\Queue
 */
class Queue extends Facade
{
     ...
     *
     * @return \LaraPress\Support\Testing\Fakes\QueueFake
     */
