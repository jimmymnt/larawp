...
use LaraPress\Contracts\Support\DeferringDisplayableValue;
use LaraPress\Contracts\Support\Htmlable;
use LaraPress\Support\Arr;
use LaraPress\Support\Env;
use LaraPress\Support\HigherOrderTapProxy;
use LaraPress\Support\Optional;
...
if (!function_exists('lp_e')) {
     ...
     *
     * @param \LaraPress\Contracts\Support\DeferringDisplayableValue|\LaraPress\Contracts\Support\Htmlable|string|null $value
