...
use Closure;
use Exception;
use LaraPress\Contracts\Notifications\Dispatcher as NotificationDispatcher;
use LaraPress\Contracts\Notifications\Factory as NotificationFactory;
...
class NotificationFake implements NotificationDispatcher, NotificationFactory
{
    ...
    {
        $actualCount = lp_collect($this->notifications)
            ->flatten(1)
    ...
    public function sent($notifiable, $notification, $callback = null)
    {
        ...
        $notifications = lp_collect($this->notificationsFor($notifiable, $notification));
    ...
    public function sendNow($notifiables, $notification, array $channels = null)
    {
        ...
        foreach ($notifiables as $notifiable) {
            ...
            $this->notifications[get_class($notifiable)][$notifiable->getKey()][get_class($notification)][] = [
                ...
                'locale' => $notification->locale ?? $this->locale ?? lp_value(function () use ($notifiable) {
