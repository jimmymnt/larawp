...
class ComponentAttributeBag implements ArrayAccess, Htmlable, IteratorAggregate
{
    ...
    {
        return $this->getIterator()->current() ?? lp_value($default);
    }
    ...
    {
        return $this->attributes[$key] ?? lp_value($default);
    }
    ...
    {
        return new static(lp_collect($this->attributes)->filter($callback)->all());
    }
    ...
    public function merge(array $attributeDefaults = [], $escape = true)
    {
        ...
        [$appendableAttributes, $nonAppendableAttributes] = lp_collect($this->attributes)
     ...
     *
     * @param mixed $value
     * @return \LaraPress\View\AppendableAttributeValue
     */
