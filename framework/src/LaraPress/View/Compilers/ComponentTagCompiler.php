...
use LaraPress\View\AnonymousComponent;
use LaraPress\View\DynamicComponent;
use LaraPress\View\ViewFinderInterface;
...
class ComponentTagCompiler
{
     ...
     *
     * @var \LaraPress\View\Compilers\BladeCompiler
     */
    protected $blade;
     ...
     * @param \LaraPress\View\Compilers\BladeCompiler|null $blade
     * @return void
     */
        ...
        return lp_collect($attributes)
            ->map(function (string $value, string $attribute) use ($escapeBound) {
                return $escapeBound && isset($this->boundAttributes[$attribute]) && $value !== 'true' && !is_numeric($value)
                    ? "'{$attribute}' => \LaraPress\View\Compilers\BladeCompiler::sanitizeComponentAttribute({$value})"
                    : "'{$attribute}' => {$value}";
            })
            ->implode(',');
    }
