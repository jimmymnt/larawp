...
use Ably\AblyRest;
use Closure;
use LaraPress\Broadcasting\Broadcasters\AblyBroadcaster;
use LaraPress\Broadcasting\Broadcasters\LogBroadcaster;
use LaraPress\Broadcasting\Broadcasters\NullBroadcaster;
use LaraPress\Broadcasting\Broadcasters\PusherBroadcaster;
use LaraPress\Broadcasting\Broadcasters\RedisBroadcaster;
use LaraPress\Contracts\Broadcasting\Factory as FactoryContract;
use LaraPress\Contracts\Broadcasting\ShouldBroadcastNow;
...
/**
 * @mixin \LaraPress\Contracts\Broadcasting\Broadcaster
 */
class BroadcastManager implements FactoryContract
{
     ...
     *
     * @param \LaraPress\Contracts\Container\Container $app
     * @return void
     */
    ...
    public function routes(array $attributes = null)
    {
        ...
        $this->app['router']->group($attributes, function ($router) {
            ...
            )->withoutMiddleware([\LaraPress\Foundation\Http\Middleware\VerifyCsrfToken::class]);
        });
    }
     ...
     *
     * @param string $name
     * @return \LaraPress\Contracts\Broadcasting\Broadcaster
     */
