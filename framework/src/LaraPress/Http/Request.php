...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    /**
     * Create a new LaraPress HTTP request from server variables.
     *
     * @return static
     */
    ...
    {
        return $this->merge(lp_collect($input)->filter(function ($value, $key) {
    ...
    public function json($key = null, $default = null)
    {
        ...
        return lp_data_get($this->json->all(), $key, $default);
    }
     ...
     *
     * @param \LaraPress\Http\Request $from
     * @param \LaraPress\Http\Request|null $to
     * @return static
     */
    ...
    /**
     * Create an LaraPress request from a Symfony instance.
     *
     ...
     * @param mixed $default
     * @return \LaraPress\Routing\Route|object|string|null
     */
