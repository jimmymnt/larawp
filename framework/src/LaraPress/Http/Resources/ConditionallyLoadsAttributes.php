...
namespace LaraPress\Http\Resources;
...
trait ConditionallyLoadsAttributes
{
     ...
     * @param mixed $value
     * @param mixed $default
     * @return \LaraPress\Http\Resources\MissingValue|mixed
     */
    protected function when($condition, $value, $default = null)
    {
        if ($condition) {
            return lp_value($value);
        }

        return func_num_args() === 3 ? lp_value($default) : new MissingValue;
    }
     ...
     *
     * @param mixed $value
     * @return \LaraPress\Http\Resources\MergeValue|mixed
     */
    ...
    {
        return $condition ? new MergeValue(lp_value($value)) : new MissingValue;
    }
     ...
     * @return \LaraPress\Http\Resources\MergeValue
     */
    ...
    protected function whenAppended($attribute, $value = null, $default = null)
    {
        if ($this->resource->hasAppended($attribute)) {
            return func_num_args() >= 2 ? lp_value($value) : $this->resource->$attribute;
        }
