...
use LaraPress\Contracts\Http\Kernel as KernelContract;
use LaraPress\Foundation\Http\Events\RequestHandled;
...
class Kernel implements KernelContract
{
    ...
    protected $middlewarePriority = [
        \LaraPress\Cookie\Middleware\EncryptCookies::class,
        \LaraPress\Session\Middleware\StartSession::class,
        \LaraPress\View\Middleware\ShareErrorsFromSession::class,
        \LaraPress\Contracts\Auth\Middleware\AuthenticatesRequests::class,
        \LaraPress\Routing\Middleware\ThrottleRequests::class,
        \LaraPress\Routing\Middleware\ThrottleRequestsWithRedis::class,
        \LaraPress\Session\Middleware\AuthenticateSession::class,
        \LaraPress\Routing\Middleware\SubstituteBindings::class,
        \LaraPress\Auth\Middleware\Authorize::class,
    ];
