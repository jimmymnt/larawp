...
class RouteListCommand extends Command
{
    ...
    {
        $routes = lp_collect($this->router->getRoutes())->map(function ($route) {
    ...
    {
        return lp_collect($this->router->gatherRouteMiddleware($route))->map(function ($middleware) {
