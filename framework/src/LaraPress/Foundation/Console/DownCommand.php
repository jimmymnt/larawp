...
use LaraPress\Foundation\Events\MaintenanceModeEnabled;
use LaraPress\Foundation\Exceptions\RegisterErrorViewPaths;
use Throwable;
...
class DownCommand extends Command
{
    ...
    {
        try {
            if (is_file(lp_storage_path('framework/down'))) {
            ...
            file_put_contents(
                lp_storage_path('framework/down'),
                json_encode($this->getDownFilePayload(), JSON_PRETTY_PRINT)
            );

            file_put_contents(
                lp_storage_path('framework/maintenance.php'),
    ...
    protected function prerenderView()
    {
        ...
        return lp_view($this->option('render'), [
