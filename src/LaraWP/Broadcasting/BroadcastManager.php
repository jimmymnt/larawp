...
use Ably\AblyRest;
use Closure;
use LaraWP\Broadcasting\Broadcasters\AblyBroadcaster;
use LaraWP\Broadcasting\Broadcasters\LogBroadcaster;
use LaraWP\Broadcasting\Broadcasters\NullBroadcaster;
use LaraWP\Broadcasting\Broadcasters\PusherBroadcaster;
use LaraWP\Broadcasting\Broadcasters\RedisBroadcaster;
use LaraWP\Contracts\Broadcasting\Factory as FactoryContract;
use LaraWP\Contracts\Broadcasting\ShouldBroadcastNow;
...
/**
 * @mixin \LaraWP\Contracts\Broadcasting\Broadcaster
 */
class BroadcastManager implements FactoryContract
{
     ...
     *
     * @param \LaraWP\Contracts\Container\Container $app
     * @return void
     */
    ...
    public function routes(array $attributes = null)
    {
        ...
        $this->app['router']->group($attributes, function ($router) {
            ...
            )->withoutMiddleware([\LaraWP\Foundation\Http\Middleware\VerifyCsrfToken::class]);
        });
    }
