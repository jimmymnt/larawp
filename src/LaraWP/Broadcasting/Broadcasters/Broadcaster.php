...
namespace LaraWP\Broadcasting\Broadcasters;

use Exception;
use LaraWP\Container\Container;
use LaraWP\Contracts\Broadcasting\Broadcaster as BroadcasterContract;
...
abstract class Broadcaster implements BroadcasterContract
{
     ...
     *
     * @var \LaraWP\Contracts\Routing\BindingRegistrar
     */
     ...
     *
     * @param \LaraWP\Contracts\Broadcasting\HasBroadcastChannel|string $channel
    ...
    protected function extractAuthParameters($pattern, $channel, $callback)
    {
        ...
        return lp_collect($this->extractChannelKeys($pattern, $channel))->reject(function ($value, $key) {
     ...
     *
     * @return \LaraWP\Contracts\Routing\BindingRegistrar
     */
