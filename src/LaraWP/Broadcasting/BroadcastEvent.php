...
use LaraWP\Contracts\Broadcasting\Factory as BroadcastingFactory;
...
class BroadcastEvent implements ShouldQueue
{
     ...
     *
     * @param \LaraWP\Contracts\Broadcasting\Factory $manager
     * @return void
     */
    ...
    protected function getPayloadFromEvent($event)
    {
        if (method_exists($event, 'broadcastWith') &&
            ...
            return array_merge($payload, ['socket' => lp_data_get($event, 'socket')]);
        }
