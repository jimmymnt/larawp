...
use LaraWP\Redis\Connections\PhpRedisClusterConnection;
use LaraWP\Redis\Connections\PhpRedisConnection;
use LaraWP\Support\Arr;
use LaraWP\Support\Facades\Redis as RedisFacade;
...
class PhpRedisConnector implements Connector
{
     ...
     * @param array $config
     * @param array $options
     * @return \LaraWP\Redis\Connections\PhpRedisConnection
     */
     ...
     * @param array $options
     * @return \LaraWP\Redis\Connections\PhpRedisClusterConnection
     */
