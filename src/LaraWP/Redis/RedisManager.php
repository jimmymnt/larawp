...
namespace LaraWP\Redis;

use Closure;
use LaraWP\Contracts\Redis\Factory;
use LaraWP\Redis\Connections\Connection;
use LaraWP\Redis\Connectors\PhpRedisConnector;
use LaraWP\Redis\Connectors\PredisConnector;
use LaraWP\Support\Arr;
use LaraWP\Support\ConfigurationUrlParser;
use InvalidArgumentException;

/**
 * @mixin \LaraWP\Redis\Connections\Connection
 */
class RedisManager implements Factory
{
     ...
     *
     * @param \LaraWP\Redis\Connections\Connection $connection
     * @param string $name
     * @return \LaraWP\Redis\Connections\Connection
     */
     ...
     *
     * @return \LaraWP\Contracts\Redis\Connector
     */
