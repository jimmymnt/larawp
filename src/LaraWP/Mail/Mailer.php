...
use LaraWP\Contracts\Mail\MailQueue as MailQueueContract;
use LaraWP\Contracts\Queue\Factory as QueueContract;
use LaraWP\Contracts\Queue\ShouldQueue;
use LaraWP\Contracts\Support\Htmlable;
use LaraWP\Contracts\View\Factory;
use LaraWP\Mail\Events\MessageSending;
use LaraWP\Mail\Events\MessageSent;
...
class Mailer implements MailerContract, MailQueueContract
{
     ...
     *
     * @var \LaraWP\Contracts\View\Factory
     */
    protected $views;
     ...
     *
     * @param string $name
     * @param \LaraWP\Contracts\View\Factory $views
     * @param \Swift_Mailer $swift
     * @param \LaraWP\Contracts\Events\Dispatcher|null $events
     * @return void
     */
     ...
     *
     * @param mixed $users
     * @return \LaraWP\Mail\PendingMail
     */
     ...
     *
     * @param string $queue
     * @param \LaraWP\Contracts\Mail\Mailable $view
     * @return mixed
     */
     ...
     *
     * @return \LaraWP\Contracts\View\Factory
     */
