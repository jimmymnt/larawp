...
/**
 * @mixin \LaraWP\Database\Connection
 */
class DatabaseManager implements ConnectionResolverInterface
{
     ...
     *
     * @var \LaraWP\Database\Connectors\ConnectionFactory
     */
    protected $factory;
     ...
     * @param \LaraWP\Database\Connectors\ConnectionFactory $factory
     * @return void
     */
    ...
    public function usingConnection($name, callable $callback)
    {
        ...
        return lp_tap($callback(), function () use ($previousName) {
