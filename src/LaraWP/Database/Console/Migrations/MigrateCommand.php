...
namespace LaraWP\Database\Console\Migrations;

use LaraWP\Console\ConfirmableTrait;
use LaraWP\Contracts\Events\Dispatcher;
use LaraWP\Database\Events\SchemaLoaded;
use LaraWP\Database\Migrations\Migrator;
use LaraWP\Database\SqlServerConnection;
...
class MigrateCommand extends BaseCommand
{
     ...
     *
     * @var \LaraWP\Database\Migrations\Migrator
     */
    protected $migrator;
     ...
     *
     * @param \LaraWP\Database\Migrations\Migrator $migrator
