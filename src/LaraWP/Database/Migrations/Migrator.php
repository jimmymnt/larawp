...
namespace LaraWP\Database\Migrations;

use Doctrine\DBAL\Schema\SchemaException;
use LaraWP\Contracts\Events\Dispatcher;
use LaraWP\Database\ConnectionResolverInterface as Resolver;
use LaraWP\Database\Events\MigrationEnded;
use LaraWP\Database\Events\MigrationsEnded;
use LaraWP\Database\Events\MigrationsStarted;
use LaraWP\Database\Events\MigrationStarted;
use LaraWP\Database\Events\NoPendingMigrations;
...
class Migrator
{
     ...
     *
     * @var \LaraWP\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @param \LaraWP\Database\Migrations\MigrationRepositoryInterface $repository
     ...
     *
     * @return \LaraWP\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @return \LaraWP\Filesystem\Filesystem
     */
     ...
     *
     * @param \LaraWP\Contracts\Database\Events\MigrationEvent $event
     * @return void
     */
