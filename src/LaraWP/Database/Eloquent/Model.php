...
use LaraWP\Contracts\Support\CanBeEscapedWhenCastToString;
use LaraWP\Contracts\Support\Jsonable;
use LaraWP\Database\ConnectionResolverInterface as Resolver;
...
use LaraWP\Database\Eloquent\Relations\HasManyThrough;
use LaraWP\Database\Eloquent\Relations\Pivot;
use LaraWP\Support\Arr;
use LaraWP\Support\Collection as BaseCollection;
use LaraWP\Support\Str;
use LaraWP\Support\Traits\ForwardsCalls;
use JsonSerializable;
use LogicException;
use LaraWP\Database\Eloquent\Contracts\Model as ModelContract;
...
abstract class Model implements ModelContract, Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
     ...
     * @return $this
     *
     * @throws \LaraWP\Database\Eloquent\MassAssignmentException
     */
     ...
     *
     * @param \LaraWP\Database\Eloquent\Builder $query
     * @return bool
     */
     ...
     *
     * @param \LaraWP\Support\Collection|array|int|string $ids
     * @return int
     */
     ...
     *
     * @return \LaraWP\Database\Eloquent\Builder|static
     */
     ...
     * @return \LaraWP\Database\Eloquent\Relations\Pivot
     */
     ...
     * @return string
     *
     * @throws \LaraWP\Database\Eloquent\JsonEncodingException
     */
     ...
     *
     * @param \LaraWP\Database\Eloquent\Model|null $model
     * @return bool
     */
     ...
     *
     * @return \LaraWP\Database\Connection
     */
     ...
     *
     * @return \LaraWP\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param \LaraWP\Database\ConnectionResolverInterface $resolver
     * @return void
     */
     ...
     * @return \LaraWP\Database\Eloquent\Model|null
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param \LaraWP\Database\Eloquent\Model|LaraWP\Database\Eloquent\Relations\Relation $query
     * @param mixed $value
     * @param string|null $field
     * @return \LaraWP\Database\Eloquent\Relations\Relation
     */
