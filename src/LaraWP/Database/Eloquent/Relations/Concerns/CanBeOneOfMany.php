...
namespace LaraWP\Database\Eloquent\Relations\Concerns;
...
trait CanBeOneOfMany
{
     ...
     *
     * @var \LaraWP\Database\Eloquent\Builder|null
     */
     ...
     *
     * @param \LaraWP\Database\Eloquent\JoinClause $join
     * @return void
     */
     ...
     *
     * @param \LaraWP\Database\Eloquent\Builder $parent
     * @param \LaraWP\Database\Eloquent\Builder $subQuery
     * @param string $on
     * @return void
     */
     ...
     *
     * @return \LaraWP\Database\Eloquent\Builder|void
     */
