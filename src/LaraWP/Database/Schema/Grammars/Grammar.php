...
namespace LaraWP\Database\Schema\Grammars;
...
use LaraWP\Database\Schema\Blueprint;
...
abstract class Grammar extends BaseGrammar
{
     ...
     *
     * @param \LaraWP\Database\Schema\Blueprint $blueprint
     * @param \LaraWP\Support\Fluent $command
     * @param \LaraWP\Database\Connection $connection
     * @return array
     */
     ...
     *
     * @param \LaraWP\Support\Fluent $column
     * @return string
     */
     ...
     * @param \LaraWP\Database\Schema\Blueprint $blueprint
     * @param string $name
     * @return \LaraWP\Support\Fluent|null
     */
    ...
    public function getDoctrineTableDiff(Blueprint $blueprint, SchemaManager $schema)
    {
        ...
        return lp_tap(new TableDiff($table), function ($tableDiff) use ($schema, $table) {
