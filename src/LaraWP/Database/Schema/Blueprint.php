...
namespace LaraWP\Database\Schema;

use BadMethodCallException;
use Closure;
use LaraWP\Database\Connection;
use LaraWP\Database\Query\Expression;
use LaraWP\Database\Schema\Grammars\Grammar;
use LaraWP\Database\SQLiteConnection;
...
class Blueprint
{
     ...
     *
     * @var \LaraWP\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
    ...
    {
        return lp_collect($this->commands)->filter(function ($command) use ($names) {
    ...
    {
        return lp_collect($this->commands)->contains(function ($command) {
     ...
     * @param string|array $columns
     * @param string|null $name
     * @return \LaraWP\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param string $column
     * @return \LaraWP\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param string $column
     * @return \LaraWP\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param \LaraWP\Database\Schema\ColumnDefinition $definition
     * @return \LaraWP\Database\Schema\ColumnDefinition
     */
    ...
    {
        return !is_null(lp_collect($this->getAddedColumns())->first(function ($column) {
    ...
    public function autoIncrementingStartingValues()
    {
        ...
        return lp_collect($this->getAddedColumns())->mapWithKeys(function ($column) {
            return $column->autoIncrement === true
