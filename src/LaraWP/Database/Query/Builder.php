...
namespace LaraWP\Database\Query;

use BackedEnum;
use Closure;
use DateTimeInterface;
use LaraWP\Contracts\Support\Arrayable;
use LaraWP\Database\Concerns\BuildsQueries;
use LaraWP\Database\Concerns\ExplainsQueries;
use LaraWP\Database\ConnectionInterface;
use LaraWP\Database\Eloquent\Builder as EloquentBuilder;
use LaraWP\Database\Eloquent\Relations\Relation;
use LaraWP\Database\Query\Grammars\Grammar;
use LaraWP\Database\Query\Processors\Processor;
...
use LaraWP\Support\Traits\ForwardsCalls;
...
class Builder
{
     ...
     *
     * @var \LaraWP\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \LaraWP\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     *
     * @param \LaraWP\Database\ConnectionInterface $connection
     * @param \LaraWP\Database\Query\Grammars\Grammar|null $grammar
     * @param \LaraWP\Database\Query\Processors\Processor|null $processor
     * @return void
     */
     ...
     *
     * @param \Closure|\LaraWP\Database\Query\Builder|\LaraWP\Database\Eloquent\Builder|string $query
     * @param string $as
     * @return $this
     *
     ...
     *
     * @param \Closure|\LaraWP\Database\Query\Builder|string $query
     * @param string $as
     * @return $this
     *
     * @throws \InvalidArgumentException
     ...
     *
     * @param \Closure|\LaraWP\Database\Query\Builder|string $table
     ...
     *
     * @param \LaraWP\Database\Query\Builder $parentQuery
     * @param string $type
     * @param string $table
     * @return \LaraWP\Database\Query\JoinClause
     */
     ...
     *
     * @param string $column
     * @param \LaraWP\Contracts\Support\Arrayable|array $values
     * @param string $boolean
     * @param bool $not
     * @return $this
     */
     ...
     *
     * @param string|\LaraWP\Database\Query\Expression $column
     * @param array $values
     * @param string $boolean
     * @param bool $not
     * @return $this
     ...
     *
     * @param \LaraWP\Database\Query\Expression|string $column
     * @param string $operator
     ...
     *
     * @param \LaraWP\Database\Query\Builder $query
     * @param string $boolean
     * @return $this
     */
     ...
     *
     * @param \Closure|\LaraWP\Database\Eloquent\Builder|\LaraWP\Database\Query\Builder|\LaraWP\Database\Query\Expression|string $column
     ...
     *
     * @param \Closure|\LaraWP\Database\Query\Builder|\LaraWP\Database\Query\Expression|string|null $column
     * @param string $direction
     * @return $this
     */
     ...
     *
     * @param \LaraWP\Database\Query\Builder|\Closure $query
     * @param bool $all
     * @return $this
     */
     ...
     *
     * @param mixed $value
     * @return \LaraWP\Database\Query\Expression
     */
     ...
     *
     * @return \LaraWP\Database\ConnectionInterface
     */
     ...
     *
     * @return \LaraWP\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \LaraWP\Database\Query\Grammars\Grammar
     */
