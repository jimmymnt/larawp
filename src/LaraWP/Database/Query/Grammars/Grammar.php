...
namespace LaraWP\Database\Query\Grammars;

use LaraWP\Database\Grammar as BaseGrammar;
use LaraWP\Database\Query\Builder;
use LaraWP\Database\Query\JoinClause;
...
class Grammar extends BaseGrammar
{
     ...
     *
     * @param \LaraWP\Database\Query\Expression|string $value
