...
use LaraWP\Contracts\Database\Eloquent\CastsInboundAttributes;
use LaraWP\Contracts\Support\Arrayable;
use LaraWP\Database\Eloquent\Casts\AsArrayObject;
use LaraWP\Database\Eloquent\Casts\AsCollection;
use LaraWP\Database\Eloquent\Casts\Attribute;
use LaraWP\Database\Eloquent\InvalidCastException;
use LaraWP\Database\Eloquent\JsonEncodingException;
use LaraWP\Database\Eloquent\Relations\Relation;
use LaraWP\Database\LazyLoadingViolationException;
...
trait HasAttributes
{
     ...
     * @return bool
     *
     * @throws \LaraWP\Database\Eloquent\InvalidCastException
     */
