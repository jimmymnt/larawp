...
use LaraWP\Wordpress\Http\Response\Content;
use LaraWP\Wordpress\Http\Response\Shortcode;
use LaraWP\Wordpress\Http\Response\Page;
...
if (!function_exists('lp_view')) {
     ...
     * @return \LaraWP\Wordpress\Http\Response\Page
     */
...
if (!function_exists('content_view')) {
     ...
     * @param \LaraWP\Contracts\Support\Arrayable|array $data
     * @param array $mergeData
     * @return \LaraWP\Wordpress\Http\Response\Content
     */
...
if (!function_exists('shortcode_view')) {
     ...
     * @param array $mergeData
     * @param string $tag
     * @return \LaraWP\Wordpress\Http\Response\Shortcode
     */
...
if (!function_exists('lp_admin_menu')) {
     ...
     * @return null|\LaraWP\Wordpress\Admin\Routing\Menu
     */
...
if (!function_exists('lp_pass')) {
    /**
     * Bypass response
     * @return \LaraWP\Wordpress\Http\Response\PassThrough
     */
    function lp_pass()
    {
...
if (!function_exists('lp_setting')) {
     ...
     * @param $key
     * @param $default
     * @return mixed|\LaraWP\Wordpress\Setting\Repository|null
     */
...
if (!function_exists('lp_admin_notice')) {
     ...
     * @param $message
     * @param $type
     * @return \LaraWP\Wordpress\Admin\Notice\NoticeManager|\LaraWP\Wordpress\Admin\Notice\Message
     */
