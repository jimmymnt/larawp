 ...
 * @method static \LaraWP\Wordpress\Routing\Route any(string $uri, array|string|callable|null $action = null)
 * @method static \LaraWP\Wordpress\Routing\Route|null current()
 * @method static \LaraWP\Wordpress\Routing\Route delete(string $uri, array|string|callable|null $action = null)
 * @method static \LaraWP\Wordpress\Routing\Route fallback(array|string|callable|null $action = null)
 * @method static \LaraWP\Wordpress\Routing\Route get(string $uri, array|string|callable|null $action = null)
 * @method static \LaraWP\Wordpress\Routing\Route|null getCurrentRoute()
 * @method static \LaraWP\Routing\RouteCollectionInterface getRoutes()
 * @method static \LaraWP\Wordpress\Routing\Route match(array|string $methods, string $uri, array|string|callable|null $action = null)
 * @method static \LaraWP\Wordpress\Routing\Route options(string $uri, array|string|callable|null $action = null)
 * @method static \LaraWP\Wordpress\Routing\Route patch(string $uri, array|string|callable|null $action = null)
 * @method static \LaraWP\Wordpress\Routing\Route permanentRedirect(string $uri, string $destination)
 * @method static \LaraWP\Wordpress\Routing\Route post(string $uri, array|string|callable|null $action = null)
 * @method static \LaraWP\Wordpress\Routing\Route put(string $uri, array|string|callable|null $action = null)
 * @method static \LaraWP\Wordpress\Routing\Route redirect(string $uri, string $destination, int $status = 302)
 * @method static \LaraWP\Wordpress\Routing\Route substituteBindings(\LaraWP\Support\Facades\Route $route)
 * @method static \LaraWP\Wordpress\Routing\Route view(string $uri, string $view, array $data = [], int|array $status = 200, array $headers = [])
 ...
 *
 * @see \LaraWP\Wordpress\Routing\Router
 */
