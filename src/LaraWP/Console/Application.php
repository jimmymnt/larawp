...
namespace LaraWP\Console;

use Closure;
use LaraWP\Console\Events\ArtisanStarting;
use LaraWP\Console\Events\CommandFinished;
use LaraWP\Console\Events\CommandStarting;
use LaraWP\Contracts\Console\Application as ApplicationContract;
...
class Application extends SymfonyApplication implements ApplicationContract
{
     ...
     *
     * @param \LaraWP\Contracts\Container\Container $laravel
    ...
    {
        return lp_tap(parent::getDefaultInputDefinition(), function ($definition) {
