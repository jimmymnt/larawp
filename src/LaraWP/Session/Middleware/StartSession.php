...
class StartSession
{
     ...
     * The session manager.
     *
     * @var \LaraWP\Session\SessionManager
     */
    protected $manager;
     ...
     *
     * @param \LaraWP\Session\SessionManager $manager
    ...
    {
        return lp_tap($session, function ($session) use ($request) {
    ...
    {
        return lp_tap($this->manager->driver(), function ($session) use ($request) {
