...
class ServeCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $environmentLastModified = $hasEnvironment
            ...
            : lp_now()->addDays(30)->getTimestamp();
    ...
    {
        $process = new Process($this->serverCommand(), null, lp_collect($_ENV)->mapWithKeys(function ($value, $key) use ($hasEnvironment) {
