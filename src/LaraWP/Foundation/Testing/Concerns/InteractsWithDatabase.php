...
use LaraWP\Support\Facades\DB;
use LaraWP\Testing\Constraints\CountInDatabase;
use LaraWP\Testing\Constraints\HasInDatabase;
use LaraWP\Testing\Constraints\NotSoftDeletedInDatabase;
use LaraWP\Testing\Constraints\SoftDeletedInDatabase;
...
trait InteractsWithDatabase
{
     ...
     *
     * @param \LaraWP\Database\Eloquent\Model|string $table
     * @param array $data
