...
use LaraWP\Http\Resources\Json\JsonResource;
...
/**
 * @mixin \LaraWP\Support\Collection
 */
abstract class AbstractCursorPaginator implements Htmlable
{
     ...
     * The current cursor.
     *
     * @var \LaraWP\Pagination\Cursor|null
     */
    protected $cursor;
     ...
     *
     * @param \LaraWP\Pagination\Cursor|null $cursor
     * @return string
     */
     ...
     *
     * @return \LaraWP\Pagination\Cursor|null
     */
     ...
     * @param bool $isNext
     * @return \LaraWP\Pagination\Cursor
     */
     ...
     *
     * @param \LaraWP\Support\Collection $collection
     * @return $this
     */
