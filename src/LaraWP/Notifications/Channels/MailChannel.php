...
class MailChannel
{
     ...
     *
     * @var \LaraWP\Contracts\Mail\Factory
     */
    protected $mailer;
     ...
     *
     * @param \LaraWP\Contracts\Mail\Factory $mailer
     ...
     * @param mixed $notifiable
     * @param \LaraWP\Notifications\Notification $notification
     * @param \LaraWP\Notifications\Messages\MailMessage $message
     * @return \Closure
     */
     ...
     *
     * @param \LaraWP\Mail\Message $mailMessage
     * @param mixed $notifiable
     * @param \LaraWP\Notifications\Notification $notification
     * @param \LaraWP\Notifications\Messages\MailMessage $message
     * @return void
    ...
    protected function buildMessage($mailMessage, $notifiable, $notification, $message)
    {
        ...
        $mailMessage->subject($message->subject ?: Str::title(
            Str::snake(lp_class_basename($notification), ' ')
        ));
    ...
    protected function getRecipients($notifiable, $notification, $message)
    {
        ...
        return lp_collect($recipients)->mapWithKeys(function ($recipient, $email) {
