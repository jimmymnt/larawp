...
use LaraWP\Contracts\Support\MessageBag as MessageBagContract;
...
class MessageBag implements Jsonable, JsonSerializable, MessageBagContract, MessageProvider
{
     ...
     *
     * @param \LaraWP\Contracts\Support\MessageProvider|array $messages
     * @return $this
     */
    ...
    {
        return lp_collect($this->messages)
    ...
    {
        return lp_collect((array)$messages)
