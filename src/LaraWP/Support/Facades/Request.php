 ...
 * @method static \LaraWP\Http\Request capture()
 * @method static \LaraWP\Http\Request createFrom(\LaraWP\Http\Request $from, \LaraWP\Http\Request|null $to = null)
 * @method static \LaraWP\Http\Request createFromBase(\Symfony\Component\HttpFoundation\Request $request)
 * @method static \LaraWP\Http\Request duplicate(array|null $query = null, array|null $request = null, array|null $attributes = null, array|null $cookies = null, array|null $files = null, array|null $server = null)
 * @method static \LaraWP\Http\Request instance()
 * @method static \LaraWP\Http\Request merge(array $input)
 * @method static \LaraWP\Http\Request replace(array $input)
 * @method static \LaraWP\Http\Request setJson(\Symfony\Component\HttpFoundation\ParameterBag $json)
 * @method static \LaraWP\Http\Request setRouteResolver(\Closure $callback)
 * @method static \LaraWP\Http\Request setUserResolver(\Closure $callback)
 * @method static \LaraWP\Http\UploadedFile|\LaraWP\Http\UploadedFile[]|array|null file(string|null $key = null, mixed $default = null)
 * @method static \LaraWP\Routing\Route|object|string route(string|null $param = null, string|null $default = null)
 * @method static \LaraWP\Session\Store session()
 * @method static \LaraWP\Session\Store|null getSession()
 ...
 * @method static void setLaravelSession(\LaraWP\Contracts\Session\Session $session)
 *
 * @see \LaraWP\Http\Request
 */
