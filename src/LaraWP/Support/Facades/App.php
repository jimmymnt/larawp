...
/**
 * @method static \LaraWP\Contracts\Foundation\Application loadEnvironmentFrom(string $file)
 * @method static \LaraWP\Support\ServiceProvider register(\LaraWP\Support\ServiceProvider|string $provider, bool $force = false)
 * @method static \LaraWP\Support\ServiceProvider resolveProvider(string $provider)
 * @method static array getProviders(\LaraWP\Support\ServiceProvider|string $provider)
 ...
 *
 * @see \LaraWP\Contracts\Foundation\Application
 */
