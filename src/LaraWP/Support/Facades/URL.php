...
/**
 * @method static \LaraWP\Contracts\Routing\UrlGenerator setRootControllerNamespace(string $rootNamespace)
 * @method static bool hasValidSignature(\LaraWP\Http\Request $request, bool $absolute = true)
 ...
 *
 * @see \LaraWP\Routing\UrlGenerator
 */
