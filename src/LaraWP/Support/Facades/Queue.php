...
use LaraWP\Support\Testing\Fakes\QueueFake;

/**
 * @method static \LaraWP\Contracts\Queue\Job|null pop(string $queue = null)
 * @method static \LaraWP\Contracts\Queue\Queue setConnectionName(string $name)
 ...
 *
 * @see \LaraWP\Queue\QueueManager
 * @see \LaraWP\Queue\Queue
 */
class Queue extends Facade
{
     ...
     *
     * @return \LaraWP\Support\Testing\Fakes\QueueFake
     */
