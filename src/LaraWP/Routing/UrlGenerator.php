...
use Closure;
use LaraWP\Contracts\Routing\UrlGenerator as UrlGeneratorContract;
...
class UrlGenerator implements UrlGeneratorContract
{
     ...
     *
     * @var \LaraWP\Routing\RouteUrlGenerator|null
     */
     ...
     *
     * @param \LaraWP\Routing\RouteCollectionInterface $routes
     ...
     * @return string
     *
     * @throws \LaraWP\Routing\Exceptions\UrlGenerationException
     */
    public function toRoute($route, $parameters, $absolute)
    {
        $parameters = lp_collect(Arr::wrap($parameters))->map(function ($value, $key) use ($route) {
     ...
     * @param string $root
     * @param string $path
     * @param \LaraWP\Routing\Route|null $route
     * @return string
     */
     ...
     *
     * @return \LaraWP\Routing\RouteUrlGenerator
     */
    ...
    public function setRequest(Request $request)
    {
        ...
        lp_tap(lp_optional($this->routeGenerator)->defaultParameters ?: [], function ($defaults) {
     ...
     *
     * @return \LaraWP\Session\Store|null
     */
