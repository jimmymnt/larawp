...
use LaraWP\Contracts\Routing\BindingRegistrar;
use LaraWP\Contracts\Routing\Registrar as RegistrarContract;
...
use LaraWP\Routing\Events\RouteMatched;
use LaraWP\Support\Collection;
use LaraWP\Support\Str;
use LaraWP\Support\Stringable;
...
/**
 * @mixin \LaraWP\Routing\RouteRegistrar
 */
class Router implements BindingRegistrar, RegistrarContract
{
     ...
     *
     * @var \LaraWP\Routing\RouteCollectionInterface
     */
    protected $routes;
     ...
     * @param \LaraWP\Container\Container|null $container
     * @return void
     */
    ...
    {
        return $this->any($uri, '\LaraWP\Routing\RedirectController')
    ...
    {
        return $this->match(['GET', 'HEAD'], $uri, '\LaraWP\Routing\ViewController')
            ->setDefaults([
                'view' => $view,
                'data' => $data,
     ...
     *
     * @param \LaraWP\Support\Collection $middlewares
     * @return array
     */
     ...
     *
     * @return \LaraWP\Routing\RouteCollectionInterface
     */
