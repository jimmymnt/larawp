...
trait CompilesConditionals
{
    ...
    protected function compileAuth($guard = null)
    {
        ...
        return "<?php if(lp_auth()->guard{$guard}->check()): ?>";
    }
    ...
    protected function compileElseAuth($guard = null)
    {
        ...
        return "<?php elseif(lp_auth()->guard{$guard}->check()): ?>";
    }
    ...
    {
        return "<?php if(lp_app()->environment{$environments}): ?>";
    }
    ...
    {
        return "<?php if(lp_app()->environment('production')): ?>";
    }
    ...
    protected function compileGuest($guard = null)
    {
        ...
        return "<?php if(lp_auth()->guard{$guard}->guest()): ?>";
    }
    ...
    protected function compileElseGuest($guard = null)
    {
        ...
        return "<?php elseif(lp_auth()->guard{$guard}->guest()): ?>";
    }
