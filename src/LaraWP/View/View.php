...
use LaraWP\Contracts\Support\MessageProvider;
...
class View implements ArrayAccess, Htmlable, ViewContract
{
     ...
     *
     * @var \LaraWP\Contracts\View\Engine
     */
    protected $engine;
     ...
     *
     * @param \LaraWP\View\Factory $factory
     * @param \LaraWP\Contracts\View\Engine $engine
     * @param string $view
     * @param string $path
     * @param mixed $data
     * @return void
     ...
     *
     * @param \LaraWP\Contracts\Support\MessageProvider|array $provider
     * @param string $bag
     * @return $this
     */
     ...
     *
     * @param \LaraWP\Contracts\Support\MessageProvider|array|string $provider
