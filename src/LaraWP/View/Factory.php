...
use LaraWP\Contracts\View\Factory as FactoryContract;
use LaraWP\Support\Arr;
use LaraWP\Support\Str;
use LaraWP\Support\Traits\Macroable;
use LaraWP\View\Engines\EngineResolver;
...
class Factory implements FactoryContract
{
     ...
     *
     * @var \LaraWP\View\Engines\EngineResolver
     */
    protected $engines;
     ...
     *
     * @var \LaraWP\View\ViewFinderInterface
     */
    protected $finder;
     ...
     *
     * @param \LaraWP\View\Engines\EngineResolver $engines
     * @param \LaraWP\View\ViewFinderInterface $finder
     ...
     * @return \LaraWP\Contracts\View\View
     */
    public function file($path, $data = [], $mergeData = [])
    {
        $data = array_merge($mergeData, $this->parseData($data));

        return lp_tap($this->viewInstance($path, $path, $data), function ($view) {
    ...
    public function make($view, $data = [], $mergeData = [])
    {
        ...
        return lp_tap($this->viewInstance($view, $path, $data), function ($view) {
            $this->callCreator($view);
        });
    }
     ...
     *
     * @param string $path
     * @return \LaraWP\Contracts\View\Engine
     *
     * @throws \InvalidArgumentException
     */
     ...
     *
     * @return \LaraWP\View\Engines\EngineResolver
     */
     ...
     *
     * @return \LaraWP\View\ViewFinderInterface
     */
     ...
     *
     * @return \LaraWP\Contracts\Container\Container
     */
