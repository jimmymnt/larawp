...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    /**
     * Create a new LaraWP HTTP request from server variables.
     *
     * @return static
     */
     ...
     *
     * @param \LaraWP\Http\Request $from
     * @param \LaraWP\Http\Request|null $to
     * @return static
     */
    ...
    /**
     * Create an LaraWP request from a Symfony instance.
     *
     ...
     * @param mixed $default
     * @return \LaraWP\Routing\Route|object|string|null
     */
