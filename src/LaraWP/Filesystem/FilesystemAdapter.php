...
namespace LaraWP\Filesystem;

use Closure;
use LaraWP\Contracts\Filesystem\Cloud as CloudFilesystemContract;
use LaraWP\Contracts\Filesystem\FileExistsException as ContractFileExistsException;
use LaraWP\Contracts\Filesystem\FileNotFoundException as ContractFileNotFoundException;
use LaraWP\Contracts\Filesystem\Filesystem as FilesystemContract;
use LaraWP\Http\File;
use LaraWP\Http\UploadedFile;
...
class FilesystemAdapter implements CloudFilesystemContract
{
     ...
     * @return string
     *
     * @throws \LaraWP\Contracts\Filesystem\FileNotFoundException
     */
     ...
     *
     * @param string $path
     * @param \Psr\Http\Message\StreamInterface|\LaraWP\Http\File|\LaraWP\Http\UploadedFile|string|resource $contents
     * @param mixed $options
     * @return bool
     */
     ...
     *
     * @param string $path
     * @param \LaraWP\Http\File|\LaraWP\Http\UploadedFile|string $file
     * @param mixed $options
     * @return string|false
     */
