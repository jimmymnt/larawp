...
use Closure;
use LaraWP\Contracts\Queue\Factory as FactoryContract;
use LaraWP\Contracts\Queue\Monitor as MonitorContract;
...
class QueueManager implements FactoryContract, MonitorContract
{
     ...
     *
     * @param string $driver
     * @return \LaraWP\Queue\Connectors\ConnectorInterface
     *
     * @throws \InvalidArgumentException
     */
