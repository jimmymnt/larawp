...
use LaraWP\Contracts\Queue\ClearableQueue;
use LaraWP\Contracts\Queue\Queue as QueueContract;
use LaraWP\Database\Connection;
use LaraWP\Queue\Jobs\DatabaseJob;
use LaraWP\Queue\Jobs\DatabaseJobRecord;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param \LaraWP\Database\Connection $database
     * @param string $table
     ...
     *
     * @param string $queue
     * @param \LaraWP\Queue\Jobs\DatabaseJobRecord $job
     * @param int $delay
     * @return mixed
     */
     ...
     *
     * @param string|null $queue
     * @return \LaraWP\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     * @param string $queue
     * @param \LaraWP\Queue\Jobs\DatabaseJobRecord $job
     * @return \LaraWP\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param \LaraWP\Queue\Jobs\DatabaseJobRecord $job
     * @return \LaraWP\Queue\Jobs\DatabaseJobRecord
     */
     ...
     *
     * @param string $queue
     * @param \LaraWP\Queue\Jobs\DatabaseJob $job
     * @param int $delay
     * @return void
     */
