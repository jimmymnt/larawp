...
use LaraWP\Contracts\Encryption\Encrypter;
use LaraWP\Contracts\Queue\Job;
use LaraWP\Contracts\Queue\ShouldBeUnique;
use LaraWP\Contracts\Queue\ShouldBeUniqueUntilProcessing;
use LaraWP\Database\Eloquent\ModelNotFoundException;
use LaraWP\Pipeline\Pipeline;
...
class CallQueuedHandler
{
     ...
     *
     * @param \LaraWP\Contracts\Bus\Dispatcher $dispatcher
