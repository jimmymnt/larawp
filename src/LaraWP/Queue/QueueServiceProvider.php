...
use LaraWP\Queue\Connectors\BeanstalkdConnector;
use LaraWP\Queue\Connectors\DatabaseConnector;
use LaraWP\Queue\Connectors\NullConnector;
use LaraWP\Queue\Connectors\RedisConnector;
use LaraWP\Queue\Connectors\SqsConnector;
use LaraWP\Queue\Connectors\SyncConnector;
use LaraWP\Queue\Failed\DatabaseFailedJobProvider;
use LaraWP\Queue\Failed\DatabaseUuidFailedJobProvider;
use LaraWP\Queue\Failed\DynamoDbFailedJobProvider;
use LaraWP\Queue\Failed\NullFailedJobProvider;
...
class QueueServiceProvider extends ServiceProvider implements DeferrableProvider
{
     ...
     *
     * @param \LaraWP\Queue\QueueManager $manager
     * @return void
     */
     ...
     *
     * @param array $config
     * @return \LaraWP\Queue\Failed\DatabaseFailedJobProvider
     */
     ...
     *
     * @param array $config
     * @return \LaraWP\Queue\Failed\DatabaseUuidFailedJobProvider
     */
     ...
     *
     * @param array $config
     * @return \LaraWP\Queue\Failed\DynamoDbFailedJobProvider
     */
