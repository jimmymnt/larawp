...
namespace LaraWP\Queue\Capsule;

use LaraWP\Container\Container;
use LaraWP\Queue\QueueManager;
use LaraWP\Queue\QueueServiceProvider;
use LaraWP\Support\Traits\CapsuleManagerTrait;

/**
 * @mixin \LaraWP\Queue\QueueManager
 * @mixin \LaraWP\Contracts\Queue\Queue
 */
class Manager
{
