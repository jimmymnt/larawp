...
namespace LaraWP\Queue\Jobs;

use LaraWP\Container\Container;
use LaraWP\Contracts\Queue\Job as JobContract;
use LaraWP\Queue\RedisQueue;
...
class RedisJob extends Job implements JobContract
{
     ...
     * @param \LaraWP\Queue\RedisQueue $redis
     * @param string $job
     ...
     *
     * @return \LaraWP\Queue\RedisQueue
     */
