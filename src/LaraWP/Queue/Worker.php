...
use LaraWP\Contracts\Cache\Repository as CacheContract;
use LaraWP\Contracts\Debug\ExceptionHandler;
use LaraWP\Contracts\Events\Dispatcher;
use LaraWP\Contracts\Queue\Factory as QueueManager;
use LaraWP\Database\DetectsLostConnections;
use LaraWP\Queue\Events\JobExceptionOccurred;
use LaraWP\Queue\Events\JobProcessed;
use LaraWP\Queue\Events\JobProcessing;
use LaraWP\Queue\Events\Looping;
use LaraWP\Queue\Events\WorkerStopping;
...
class Worker
{
     ...
     * @param \LaraWP\Contracts\Debug\ExceptionHandler $exceptions
     ...
     * @param string $queue
     * @param \LaraWP\Queue\WorkerOptions $options
     * @return int
     */
     ...
     *
     * @param \LaraWP\Contracts\Queue\Job|null $job
     * @param \LaraWP\Queue\WorkerOptions $options
     * @return void
     */
     ...
     *
     * @param \LaraWP\Contracts\Queue\Queue $connection
     * @param string $queue
     * @return \LaraWP\Contracts\Queue\Job|null
     */
    ...
    {
        if ($this->cache) {
            return $this->cache->get('larawp:queue:restart');
        }
    }
     ...
     *
     * @param \LaraWP\Contracts\Queue\Job $job
     * @return \LaraWP\Queue\MaxAttemptsExceededException
     */
     ...
     *
     * @return \LaraWP\Queue\QueueManager
     */
