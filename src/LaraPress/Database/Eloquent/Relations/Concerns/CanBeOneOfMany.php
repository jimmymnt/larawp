...
namespace LaraPress\Database\Eloquent\Relations\Concerns;
...
trait CanBeOneOfMany
{
     ...
     *
     * @var \LaraPress\Database\Eloquent\Builder|null
     */
    ...
    {
        return $this->ofMany(lp_collect(Arr::wrap($column))->mapWithKeys(function ($column) {
            return [$column => 'MAX'];
        })->all(), 'MAX', $relation);
    }
     ...
     *
     * @param \LaraPress\Database\Eloquent\Builder $parent
     * @param \LaraPress\Database\Eloquent\Builder $subQuery
     * @param string $on
     * @return void
     */
     ...
     *
     * @return \LaraPress\Database\Eloquent\Builder|void
     */
    ...
    {
        return $this->getRelationName() . '.' . lp_last(explode('.', $column));
    }
