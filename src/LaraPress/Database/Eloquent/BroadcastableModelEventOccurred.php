...
use LaraPress\Broadcasting\InteractsWithSockets;
use LaraPress\Broadcasting\PrivateChannel;
...
class BroadcastableModelEventOccurred implements ShouldBroadcast
{
    ...
    public function broadcastOn()
    {
        ...
        return lp_collect($channels)->map(function ($channel) {
    ...
    {
        $default = lp_class_basename($this->model) . ucfirst($this->event);
