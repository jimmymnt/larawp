...
class SqlServerGrammar extends Grammar
{
    ...
    public function compileUpsert(Builder $query, array $values, array $uniqueBy, array $update)
    {
        ...
        $on = lp_collect($uniqueBy)->map(function ($column) use ($query) {
        ...
        if ($update) {
            $update = lp_collect($update)->map(function ($value, $key) {
     ...
     *
     * @param \LaraPress\Database\Query\Expression|string $table
     * @return string
     */
