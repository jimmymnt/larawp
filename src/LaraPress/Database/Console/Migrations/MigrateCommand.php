...
namespace LaraPress\Database\Console\Migrations;

use LaraPress\Console\ConfirmableTrait;
use LaraPress\Contracts\Events\Dispatcher;
use LaraPress\Database\Events\SchemaLoaded;
use LaraPress\Database\Migrations\Migrator;
use LaraPress\Database\SqlServerConnection;
...
class MigrateCommand extends BaseCommand
{
     ...
     *
     * @var \LaraPress\Database\Migrations\Migrator
     */
    protected $migrator;
     ...
     *
     * @param \LaraPress\Database\Migrations\Migrator $migrator
    ...
    protected function schemaPath($connection)
    {
        ...
        if (file_exists($path = lp_database_path('schema/' . $connection->getName() . '-schema.dump'))) {
            return $path;
        }

        return lp_database_path('schema/' . $connection->getName() . '-schema.sql');
    }
}
