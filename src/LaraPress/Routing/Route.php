...
use LaraPress\Routing\Contracts\ControllerDispatcher as ControllerDispatcherContract;
use LaraPress\Routing\Matching\HostValidator;
use LaraPress\Routing\Matching\MethodValidator;
use LaraPress\Routing\Matching\SchemeValidator;
...
class Route
{
    ...
    protected function parseUri($uri)
    {
        ...
        return lp_tap(RouteUri::parse($uri), function ($uri) {
    ...
    {
        $groupStack = lp_last($this->router->getGroupStack());
     ...
     *
     * @return \LaraPress\Routing\Contracts\ControllerDispatcher
     */
