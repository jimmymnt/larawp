...
namespace LaraPress\Pagination;
...
use LaraPress\Http\Resources\Json\JsonResource;
...
/**
 * @mixin \LaraPress\Support\Collection
 */
abstract class AbstractCursorPaginator implements Htmlable
{
     ...
     * The current cursor.
     *
     * @var \LaraPress\Pagination\Cursor|null
     */
    protected $cursor;
     ...
     *
     * @param \LaraPress\Pagination\Cursor|null $cursor
     * @return string
     */
     ...
     *
     * @return \LaraPress\Pagination\Cursor|null
     */
     ...
     * @param bool $isNext
     * @return \LaraPress\Pagination\Cursor
     */
    ...
    {
        return lp_collect($this->parameters)
            ->flip()
     ...
     *
     * @param \LaraPress\Support\Collection $collection
     * @return $this
     */
