...
use LaraPress\Contracts\Translation\Translator;
use LaraPress\Contracts\Validation\DataAwareRule;
use LaraPress\Contracts\Validation\ImplicitRule;
use LaraPress\Contracts\Validation\Rule as RuleContract;
use LaraPress\Contracts\Validation\Validator as ValidatorContract;
use LaraPress\Contracts\Validation\ValidatorAwareRule;
use LaraPress\Support\Arr;
use LaraPress\Support\Fluent;
use LaraPress\Support\MessageBag;
use LaraPress\Support\Str;
use LaraPress\Support\ValidatedInput;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \LaraPress\Contracts\Translation\Translator
     */
     ...
     *
     * @var \LaraPress\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @var \LaraPress\Support\MessageBag
     */
    protected $messages;
     ...
     *
     * @param \LaraPress\Contracts\Translation\Translator $translator
     * @param array $data
     * @param array $rules
    ...
    {
        lp_throw_if($this->fails(), $this->exception, $this);
     ...
     * @return \LaraPress\Support\ValidatedInput|array
     */
    ...
    {
        lp_throw_if($this->invalid(), $this->exception, $this);
        ...
        foreach ($this->getRules() as $key => $rules) {
            ...
            $value = lp_data_get($this->getData(), $key, $missingValue);
     ...
     * @param string $attribute
     * @param mixed $value
     * @param \LaraPress\Contracts\Validation\Rule $rule
     * @return void
     */
    ...
    {
        return lp_collect($this->messages()->toArray())->map(function ($message, $key) {
     ...
     *
     * @return \LaraPress\Support\MessageBag
     */
    ...
    {
        $rules = lp_collect($rules)->mapWithKeys(function ($value, $key) {
     ...
     *
     * @param string $attribute
     * @return \LaraPress\Support\Fluent|array|mixed
     */
    private function dataForSometimesIteration(string $attribute, $removeLastSegmentOfAttribute)
    {
        ...
        return is_array($data = lp_data_get($this->data, $attribute))
            ? new Fluent($data)
            : $data;
    }
     ...
     * @return \LaraPress\Validation\PresenceVerifierInterface
     *
     ...
     *
     * @param \LaraPress\Validation\PresenceVerifierInterface $presenceVerifier
     * @return void
     */
     ...
     *
     * @return \LaraPress\Contracts\Translation\Translator
     */
