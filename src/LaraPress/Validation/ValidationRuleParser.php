...
class ValidationRuleParser
{
    ...
    {
        $merge = lp_head($this->explodeRules([$rules]));
    ...
    {
        return lp_collect($rules)->mapWithKeys(function ($attributeRules, $attribute) use ($data) {
            ...
            return [$attribute => lp_collect($attributeRules)->map(function ($rule) use ($data) {
