...
use Closure;
use LaraPress\Contracts\Redis\Factory;
use LaraPress\Redis\Connections\Connection;
use LaraPress\Redis\Connectors\PhpRedisConnector;
use LaraPress\Redis\Connectors\PredisConnector;
use LaraPress\Support\Arr;
use LaraPress\Support\ConfigurationUrlParser;
use InvalidArgumentException;

/**
 * @mixin \LaraPress\Redis\Connections\Connection
 */
class RedisManager implements Factory
{
     ...
     *
     * @param \LaraPress\Redis\Connections\Connection $connection
     * @param string $name
     * @return \LaraPress\Redis\Connections\Connection
     */
     ...
     *
     * @return \LaraPress\Contracts\Redis\Connector
     */
