...
class Event
{
     ...
     *
     * @var \LaraPress\Console\Scheduling\EventMutex
     */
    public $mutex;
     ...
     *
     * @param \LaraPress\Console\Scheduling\EventMutex $mutex
    ...
    protected function runCommandInForeground(Container $container)
    {
        try {
            ...
            $this->exitCode = Process::fromShellCommandline(
                $this->buildCommand(), lp_base_path(), null, null, null
            )->run();
    ...
    protected function runCommandInBackground(Container $container)
    {
        try {
            ...
            Process::fromShellCommandline($this->buildCommand(), lp_base_path(), null, null, null)->run();
    ...
    protected function ensureOutputIsBeingCaptured()
    {
        if (is_null($this->output) || $this->output == $this->getDefaultOutput()) {
            $this->sendOutputTo(lp_storage_path('logs/schedule-' . sha1($this->mutexName()) . '.log'));
        }
    }
