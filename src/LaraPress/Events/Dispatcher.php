...
use LaraPress\Contracts\Broadcasting\ShouldBroadcast;
use LaraPress\Contracts\Container\Container as ContainerContract;
use LaraPress\Contracts\Events\Dispatcher as DispatcherContract;
use LaraPress\Contracts\Queue\ShouldBeEncrypted;
...
class Dispatcher implements DispatcherContract
{
     ...
     *
     * @param \LaraPress\Contracts\Container\Container|null $container
     * @return void
     */
    ...
    public function listen($events, $listener = null)
    {
        if ($events instanceof Closure) {
            return lp_collect($this->firstClosureParameterTypes($events))
                ->each(function ($event) use ($events) {
                    $this->listen($event, $events);
                });
        } elseif ($events instanceof QueuedClosure) {
            return lp_collect($this->firstClosureParameterTypes($events->closure))
                ->each(function ($event) use ($events) {
     ...
     *
     * @param \LaraPress\Contracts\Broadcasting\ShouldBroadcast $event
     * @return void
     */
    ...
    {
        return lp_tap($job, function ($job) use ($listener) {
