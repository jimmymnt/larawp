...
use Closure;
use LaraPress\Queue\SerializableClosureFactory;
...
class QueuedClosure
{
    ...
    public function resolve()
    {
        return function (...$arguments) {
            lp_dispatch(new CallQueuedListener(InvokeQueuedClosure::class, 'handle', [
                'closure' => SerializableClosureFactory::make($this->closure),
                'arguments' => $arguments,
                'catch' => lp_collect($this->catchCallbacks)->map(function ($callback) {
