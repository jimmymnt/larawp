...
use Closure;
use LaraPress\Contracts\Cache\Factory as FactoryContract;
...
/**
 * @mixin \LaraPress\Contracts\Cache\Repository
 */
class CacheManager implements FactoryContract
{
     ...
     *
     * @param array $config
     * @return \LaraPress\Cache\Repository
     */
    ...
    {
        return lp_tap(new Repository($store), function ($repository) {
     ...
     *
     * @param \LaraPress\Cache\Repository $repository
     * @return void
     */
