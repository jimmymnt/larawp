...
use LaraPress\Cache\CacheManager;
...
class ClearCommand extends Command
{
     ...
     *
     * @var \LaraPress\Cache\CacheManager
     */
    protected $cache;
     ...
     *
     * @param \LaraPress\Cache\CacheManager $cache
    ...
    {
        if (!$this->files->exists($storagePath = lp_storage_path('framework/cache'))) {
            return;
        }
