...
use LaraPress\Contracts\Filesystem\LockTimeoutException;
use LaraPress\Filesystem\Filesystem;
use LaraPress\Filesystem\LockableFile;
...
class FileStore implements Store, LockProvider
{
    ...
    /**
     * The LaraPress Filesystem instance.
     *
    ...
    public function increment($key, $value = 1)
    {
        ...
        return lp_tap(((int)$raw['data']) + $value, function ($newValue) use ($key, $raw) {
