...
class Gate implements GateContract
{
     ...
     *
     * @param \LaraPress\Auth\Access\Response|\Closure|bool $condition
     * @param string|null $message
     * @param string|null $code
     * @return \LaraPress\Auth\Access\Response
     *
     * @throws \LaraPress\Auth\Access\AuthorizationException
     */
    ...
    protected function authorizeOnDemand($condition, $message, $code, $allowWhenResponseIs)
    {
        ...
        return lp_with($response instanceof Response ? $response : new Response(
    ...
    {
        return lp_collect($abilities)->every(function ($ability) use ($arguments) {
    ...
    {
        return lp_collect($abilities)->contains(function ($ability) use ($arguments) {
            return $this->check($ability, $arguments);
        });
    }
    ...
    public function raw($ability, $arguments = [])
    {
        ...
        return lp_tap($this->callAfterCallbacks(
    ...
    protected function guessPolicyName($class)
    {
        ...
        return Arr::wrap(Collection::times(count($classDirnameSegments), function ($index) use ($class, $classDirnameSegments) {
            ...
            return $classDirname . '\\Policies\\' . lp_class_basename($class) . 'Policy';
        })->reverse()->values()->first(function ($class) {
            return class_exists($class);
        }) ?: [$classDirname . '\\Policies\\' . lp_class_basename($class) . 'Policy']);
    }
     ...
     * @return mixed
     *
     * @throws \LaraPress\Contracts\Container\BindingResolutionException
     */
     ...
     *
     * @param \LaraPress\Contracts\Auth\Authenticatable|mixed $user
     * @return static
     */
