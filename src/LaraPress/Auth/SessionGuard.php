...
use LaraPress\Auth\Events\Attempting;
use LaraPress\Auth\Events\Authenticated;
use LaraPress\Auth\Events\CurrentDeviceLogout;
use LaraPress\Auth\Events\Failed;
use LaraPress\Auth\Events\Login;
use LaraPress\Auth\Events\Logout;
use LaraPress\Auth\Events\OtherDeviceLogout;
use LaraPress\Auth\Events\Validated;
use LaraPress\Contracts\Auth\Authenticatable as AuthenticatableContract;
use LaraPress\Contracts\Auth\StatefulGuard;
use LaraPress\Contracts\Auth\SupportsBasicAuth;
use LaraPress\Contracts\Auth\UserProvider;
use LaraPress\Contracts\Cookie\QueueingFactory as CookieJar;
use LaraPress\Contracts\Events\Dispatcher;
use LaraPress\Contracts\Session\Session;
use LaraPress\Support\Arr;
use LaraPress\Support\Facades\Hash;
use LaraPress\Support\Str;
use LaraPress\Support\Timebox;
...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
     ...
     *
     * @var \LaraPress\Contracts\Session\Session
     */
    protected $session;

    /**
     * The LaraPress cookie creator service.
     *
     * @var \LaraPress\Contracts\Cookie\QueueingFactory
     */
    protected $cookie;
     ...
     * @param \LaraPress\Contracts\Session\Session $session
     * @param \Symfony\Component\HttpFoundation\Request|null $request
     * @param \LaraPress\Support\Timebox|null $timebox
     * @return void
     */
     ...
     *
     * @return \LaraPress\Contracts\Auth\Authenticatable|null
     */
     ...
     *
     * @param \LaraPress\Auth\Recaller $recaller
     * @return mixed
     */
     ...
     *
     * @return \LaraPress\Auth\Recaller|null
     */
     ...
     *
     * @param mixed $id
     * @return \LaraPress\Contracts\Auth\Authenticatable|false
     */
    ...
    protected function rehashUserPassword($password, $attribute)
    {
        ...
        return lp_tap($this->user()->forceFill([
     ...
     *
     * @param \LaraPress\Contracts\Auth\Authenticatable|null $user
     * @param array $credentials
     * @return void
     */
     ...
     *
     * @return \LaraPress\Contracts\Cookie\QueueingFactory
     *
     ...
     *
     * @param \LaraPress\Contracts\Cookie\QueueingFactory $cookie
     * @return void
     */
     ...
     *
     * @return \LaraPress\Contracts\Events\Dispatcher
     */
     ...
     *
     * @return \LaraPress\Contracts\Session\Session
     */
     ...
     *
     * @return \LaraPress\Support\Timebox
     */
