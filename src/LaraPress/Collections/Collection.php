...
use LaraPress\Support\Traits\EnumeratesValues;
...
class Collection implements ArrayAccess, CanBeEscapedWhenCastToString, Enumerable
{
     ...
     *
     * @param \LaraPress\Support\Collection|mixed $keys
     * @return static
     */
    ...
    public function getOrPut($key, $value)
    {
        ...
        $this->offsetSet($key, $value = lp_value($value));
     ...
     * @return mixed
     *
     * @throws \LaraPress\Support\ItemNotFoundException
     * @throws \LaraPress\Support\MultipleItemsFoundException
     */
        ...
        usort($items, function ($a, $b) use ($comparisons) {
            foreach ($comparisons as $comparison) {
                ...
                if (!is_string($prop) && is_callable($prop)) {
                    ...
                    $values = [lp_data_get($a, $prop), lp_data_get($b, $prop)];
