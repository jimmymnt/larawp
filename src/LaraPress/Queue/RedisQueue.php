...
use LaraPress\Queue\Jobs\RedisJob;
...
class RedisQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param \LaraPress\Contracts\Redis\Factory $redis
     ...
     *
     * @param string $queue
     * @param \LaraPress\Queue\Jobs\RedisJob $job
     * @return void
     */
     ...
     *
     * @return \LaraPress\Contracts\Redis\Factory
     */
