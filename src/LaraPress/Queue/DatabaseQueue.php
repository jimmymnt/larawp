...
use LaraPress\Contracts\Queue\ClearableQueue;
use LaraPress\Contracts\Queue\Queue as QueueContract;
use LaraPress\Database\Connection;
use LaraPress\Queue\Jobs\DatabaseJob;
use LaraPress\Queue\Jobs\DatabaseJobRecord;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @var \LaraPress\Database\Connection
     */
    protected $database;
     ...
     *
     * @param \LaraPress\Database\Connection $database
     * @param string $table
    ...
    public function bulk($jobs, $data = '', $queue = null)
    {
        ...
        return $this->database->table($this->table)->insert(lp_collect((array)$jobs)->map(
     ...
     *
     * @param string $queue
     * @param \LaraPress\Queue\Jobs\DatabaseJobRecord $job
     * @param int $delay
     * @return mixed
     */
     ...
     *
     * @param string|null $queue
     * @return \LaraPress\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     * @param string $queue
     * @param \LaraPress\Queue\Jobs\DatabaseJobRecord $job
     * @return \LaraPress\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param string $queue
     * @param \LaraPress\Queue\Jobs\DatabaseJob $job
     * @param int $delay
     * @return void
     */
