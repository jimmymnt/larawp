 ...
 * @method static \LaraPress\Http\Request capture()
 * @method static \LaraPress\Http\Request createFrom(\LaraPress\Http\Request $from, \LaraPress\Http\Request|null $to = null)
 * @method static \LaraPress\Http\Request createFromBase(\Symfony\Component\HttpFoundation\Request $request)
 * @method static \LaraPress\Http\Request duplicate(array|null $query = null, array|null $request = null, array|null $attributes = null, array|null $cookies = null, array|null $files = null, array|null $server = null)
 * @method static \LaraPress\Http\Request instance()
 * @method static \LaraPress\Http\Request merge(array $input)
 * @method static \LaraPress\Http\Request replace(array $input)
 * @method static \LaraPress\Http\Request setJson(\Symfony\Component\HttpFoundation\ParameterBag $json)
 * @method static \LaraPress\Http\Request setRouteResolver(\Closure $callback)
 * @method static \LaraPress\Http\Request setUserResolver(\Closure $callback)
 * @method static \LaraPress\Http\UploadedFile|\LaraPress\Http\UploadedFile[]|array|null file(string|null $key = null, mixed $default = null)
 * @method static \LaraPress\Routing\Route|object|string route(string|null $param = null, string|null $default = null)
 * @method static \LaraPress\Session\Store session()
 * @method static \LaraPress\Session\Store|null getSession()
 ...
 * @method static void setLaravelSession(\LaraPress\Contracts\Session\Session $session)
 *
 * @see \LaraPress\Http\Request
 */
