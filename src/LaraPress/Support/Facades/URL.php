...
/**
 * @method static \LaraPress\Contracts\Routing\UrlGenerator setRootControllerNamespace(string $rootNamespace)
 * @method static bool hasValidSignature(\LaraPress\Http\Request $request, bool $absolute = true)
 ...
 *
 * @see \LaraPress\Routing\UrlGenerator
 */
