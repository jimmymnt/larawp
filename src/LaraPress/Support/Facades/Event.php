...
use LaraPress\Support\Testing\Fakes\EventFake;

/**
 * @method static \Closure createClassListener(string $listener, bool $wildcard = false)
 * @method static \Closure makeListener(\Closure|string $listener, bool $wildcard = false)
 * @method static \LaraPress\Events\Dispatcher setQueueResolver(callable $resolver)
 ...
 *
 * @see \LaraPress\Events\Dispatcher
 */
class Event extends Facade
{
     ...
     * @return \LaraPress\Support\Testing\Fakes\EventFake
     */
    ...
    public static function fakeFor(callable $callable, array $eventsToFake = [])
    {
        ...
        return lp_tap($callable(), function () use ($originalDispatcher) {
