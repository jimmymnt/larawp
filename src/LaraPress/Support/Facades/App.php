...
/**
 * @method static \LaraPress\Contracts\Foundation\Application loadEnvironmentFrom(string $file)
 * @method static \LaraPress\Support\ServiceProvider register(\LaraPress\Support\ServiceProvider|string $provider, bool $force = false)
 * @method static \LaraPress\Support\ServiceProvider resolveProvider(string $provider)
 * @method static array getProviders(\LaraPress\Support\ServiceProvider|string $provider)
 ...
 *
 * @see \LaraPress\Contracts\Foundation\Application
 */
