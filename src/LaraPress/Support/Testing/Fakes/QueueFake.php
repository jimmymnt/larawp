...
use Closure;
use LaraPress\Contracts\Queue\Queue;
use LaraPress\Queue\QueueManager;
...
class QueueFake extends QueueManager implements Queue
{
    ...
    public function pushed($job, $callback = null)
    {
        ...
        return lp_collect($this->jobs[$job])->filter(function ($data) use ($callback) {
    ...
    {
        return lp_collect($this->jobs)->flatten(1)->filter(function ($job) use ($queue) {
