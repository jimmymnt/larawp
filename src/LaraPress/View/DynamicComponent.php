...
use LaraPress\View\Compilers\ComponentTagCompiler;
...
class DynamicComponent extends Component
{
     ...
     *
     * @var \LaraPress\View\Compilers\BladeTagCompiler
     */
     ...
     *
     * @return \LaraPress\Contracts\View\View|string
     */
    public function render()
    {
        $template = <<<'EOF'
<?php extract(lp_collect($attributes->getAttributes())->mapWithKeys(function ($value, $key) { return [LaraPress\Support\Str::camel(str_replace([':', '.'], ' ', $key)) => $value]; })->all(), EXTR_SKIP); ?>
{{ props }}
...
EOF;
     ...
     *
     * @return \LaraPress\View\Compilers\ComponentTagCompiler
     */
