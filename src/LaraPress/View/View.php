...
use LaraPress\Contracts\Support\MessageProvider;
...
class View implements ArrayAccess, Htmlable, ViewContract
{
     ...
     *
     * @var \LaraPress\Contracts\View\Engine
     */
    protected $engine;
     ...
     *
     * @param \LaraPress\View\Factory $factory
     * @param \LaraPress\Contracts\View\Engine $engine
     * @param string $view
     * @param string $path
     * @param mixed $data
     * @return void
     ...
     *
     * @param \LaraPress\Contracts\Support\MessageProvider|array $provider
     * @param string $bag
     * @return $this
     */
     ...
     *
     * @param \LaraPress\Contracts\Support\MessageProvider|array|string $provider
     ...
     *
     * @return \LaraPress\Contracts\View\Engine
     */
