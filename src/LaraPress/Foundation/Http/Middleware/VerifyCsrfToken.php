...
namespace LaraPress\Foundation\Http\Middleware;
...
use LaraPress\Cookie\Middleware\EncryptCookies;
...
class VerifyCsrfToken
{
     ...
     * @return mixed
     *
     * @throws \LaraPress\Session\TokenMismatchException
     */
    public function handle($request, Closure $next)
    {
        if (
            ...
            return lp_tap($next($request), function ($response) use ($request) {
