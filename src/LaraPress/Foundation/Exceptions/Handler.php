...
use Closure;
use Exception;
use LaraPress\Auth\Access\AuthorizationException;
use LaraPress\Auth\AuthenticationException;
use LaraPress\Contracts\Container\BindingResolutionException;
use LaraPress\Contracts\Container\Container;
use LaraPress\Contracts\Debug\ExceptionHandler as ExceptionHandlerContract;
...
use LaraPress\Session\TokenMismatchException;
use LaraPress\Support\Arr;
use LaraPress\Support\Facades\Auth;
...
class Handler implements ExceptionHandlerContract
{
     ...
     *
     * @var \LaraPress\Foundation\Exceptions\ReportableHandler[]
     */
     ...
     * @return \LaraPress\Foundation\Exceptions\ReportableHandler
     */
     ...
     *
     * @param \LaraPress\Http\Request $request
     * @param \LaraPress\Auth\AuthenticationException $exception
     * @return \Symfony\Component\HttpFoundation\Response
     */
     ...
     *
     * @param \LaraPress\Validation\ValidationException $e
     * @param \LaraPress\Http\Request $request
     * @return \Symfony\Component\HttpFoundation\Response
     */
     ...
     *
     * @param \LaraPress\Http\Request $request
     * @param \LaraPress\Validation\ValidationException $exception
    ...
    /**
     * Map the given exception into an LaraPress response.
     *
