...
use LaraPress\Contracts\Auth\Access\Gate;
use LaraPress\Contracts\Auth\Factory as AuthFactory;
use LaraPress\Contracts\Broadcasting\Factory as BroadcastFactory;
use LaraPress\Contracts\Bus\Dispatcher;
use LaraPress\Contracts\Cookie\Factory as CookieFactory;
...
use LaraPress\Contracts\Validation\Factory as ValidationFactory;
use LaraPress\Contracts\View\Factory as ViewFactory;
use LaraPress\Foundation\Bus\PendingClosureDispatch;
use LaraPress\Foundation\Bus\PendingDispatch;
use LaraPress\Foundation\Mix;
use LaraPress\Http\Exceptions\HttpResponseException;
use LaraPress\Queue\CallQueuedClosure;
use LaraPress\Support\Facades\Date;
use LaraPress\Support\HtmlString;
...
if (!function_exists('lp_abort')) {
     ...
     *
     * @param \Symfony\Component\HttpFoundation\Response|\LaraPress\Contracts\Support\Responsable|int $code
...
if (!function_exists('lp_app')) {
     ...
     * @return mixed|\LaraPress\Contracts\Foundation\Application
     */
...
if (!function_exists('lp_auth')) {
     ...
     * @return \LaraPress\Contracts\Auth\Factory|\LaraPress\Contracts\Auth\Guard|\LaraPress\Contracts\Auth\StatefulGuard
     */
...
if (!function_exists('lp_cache')) {
     ...
     * @return mixed|\LaraPress\Cache\CacheManager
     *
     * @throws \Exception
     */
    function lp_cache()
...
if (!function_exists('lp_config')) {
     ...
     * @param mixed $default
     * @return mixed|\LaraPress\Config\Repository
     */
...
if (!function_exists('lp_cookie')) {
     ...
     * @return \LaraPress\Cookie\CookieJar|\Symfony\Component\HttpFoundation\Cookie
     */
...
if (!function_exists('lp_csrf_field')) {
     ...
     *
     * @return \LaraPress\Support\HtmlString
     */
...
if (!function_exists('lp_logger')) {
     ...
     * @param array $context
     * @return \LaraPress\Log\LogManager|null
     */
...
if (!function_exists('lp_logs')) {
     ...
     * @return \LaraPress\Log\LogManager|\Psr\Log\LoggerInterface
     */
...
if (!function_exists('lp_mix')) {
     ...
     * @return \LaraPress\Support\HtmlString|string
     *
     * @throws \Exception
     */
...
if (!function_exists('lp_now')) {
     ...
     * @return \LaraPress\Support\Carbon
     */
...
if (!function_exists('lp_redirect')) {
     ...
     * @param array $headers
     * @param bool|null $secure
     * @return \LaraPress\Routing\Redirector|\LaraPress\Http\RedirectResponse
     */
...
if (!function_exists('lp_request')) {
     ...
     * @param array|string|null $key
     * @param mixed $default
     * @return \LaraPress\Http\Request|string|array|null
     */
...
if (!function_exists('lp_response')) {
     ...
     *
     * @param \LaraPress\Contracts\View\View|string|array|null $content
     * @param int $status
     * @param array $headers
     * @return \LaraPress\Http\Response|\LaraPress\Contracts\Routing\ResponseFactory
     */
...
if (!function_exists('lp_session')) {
     ...
     * @param array|string|null $key
     * @param mixed $default
     * @return mixed|\LaraPress\Session\Store|\LaraPress\Session\SessionManager
     */
...
if (!function_exists('lp_trans')) {
     ...
     * @return \LaraPress\Contracts\Translation\Translator|string|array|null
     */
...
if (!function_exists('lp_url')) {
     ...
     * @param mixed $parameters
     * @param bool|null $secure
     * @return \LaraPress\Contracts\Routing\UrlGenerator|string
     */
...
if (!function_exists('lp_validator')) {
     ...
     * @return \LaraPress\Contracts\Validation\Validator|\LaraPress\Contracts\Validation\Factory
     */
...
if (!function_exists('lp_view')) {
     ...
     * @return \LaraPress\Contracts\View\View|\LaraPress\Contracts\View\Factory
     */
