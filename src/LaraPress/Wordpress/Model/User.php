...
namespace LaraPress\Wordpress\Model;
...
use LaraPress\Database\Eloquent\MassAssignmentException;
use LaraPress\Exceptions\WpErrorException;
use LaraPress\Wordpress\Model\Concerns\SupportMethods;
use LaraPress\Wordpress\Model\Concerns\UserQuery;
    ...
    Arrayable, ArrayAccess, Jsonable, JsonSerializable
{
    ...
    use \LaraPress\Wordpress\Model\Concerns\HasAttributes,
        \LaraPress\Wordpress\Model\Concerns\HasEvents,
        \LaraPress\Wordpress\Model\Concerns\HasGlobalScopes,
        \LaraPress\Wordpress\Model\Concerns\HasRelationships,
        \LaraPress\Wordpress\Model\Concerns\HasTimestamps,
        \LaraPress\Wordpress\Model\Concerns\HidesAttributes,
        \LaraPress\Wordpress\Model\Concerns\GuardsAttributes;
